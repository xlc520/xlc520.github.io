...
![img](http://alist.ciberviler.top/d/ecloud180/images/blogImage/MBJI4AQAPA.png)
...
![img](http://alist.ciberviler.top/d/ecloud180/images/blogImage/MBJI4AQA3M.png)
...
![img](http://alist.ciberviler.top/d/ecloud180/images/blogImage/DJKI4AQAQI.png)
...
![img](http://alist.ciberviler.top/d/ecloud180/images/blogImage/CNJY4AQAW4.png)

当任务执行完之后，线程不会退出，而是会去从阻塞队列中获取任务，如下图

![img](http://alist.ciberviler.top/d/ecloud180/images/blogImage/EFJY4AQALI.png)
...
![img](http://alist.ciberviler.top/d/ecloud180/images/blogImage/MJJI4AQAKA.png)
...
![img](http://alist.ciberviler.top/d/ecloud180/images/blogImage/MJJI4AQA4I.png)
...
![img](http://alist.ciberviler.top/d/ecloud180/images/blogImage/MNJI4AQA5Y.jpeg)
...
![img](http://alist.ciberviler.top/d/ecloud180/images/blogImage/HBJY4AQA3M.png)
...
![img](http://alist.ciberviler.top/d/ecloud180/images/blogImage/IJJY4AQADE.png)
...
![img](http://alist.ciberviler.top/d/ecloud180/images/blogImage/K5JY4AQAW4.png)
...
![img](http://alist.ciberviler.top/d/ecloud180/images/blogImage/MRJI4AQA7A.jpeg)
...
![img](http://alist.ciberviler.top/d/ecloud180/images/blogImage/MVJI4AQARI.jpeg)
...
![img](http://alist.ciberviler.top/d/ecloud180/images/blogImage/UVJY4AQARI.png)

### 六、线程池的5种状态

线程池内部有5个常量来代表线程池的五种状态

![img](http://alist.ciberviler.top/d/ecloud180/images/blogImage/VRJY4AQAWU.png)
...
![img](http://alist.ciberviler.top/d/ecloud180/images/blogImage/MZJI4AQA3M.png)
...
![img](http://alist.ciberviler.top/d/ecloud180/images/blogImage/M5JI4AQA2Q.png)

就是将线程池的状态修改为`SHUTDOWN`，然后尝试打断空闲的线程（如何判断空闲，上面在说Worker继承AQS的时候说过），也就是在阻塞等待任务的线程。

##### **shutdownNow方法**

![img](http://alist.ciberviler.top/d/ecloud180/images/blogImage/M5JI4AQA7A.png)
...
![img](http://alist.ciberviler.top/d/ecloud180/images/blogImage/NBJI4AQA3M.png)

2）单个线程数量的线程池

![img](http://alist.ciberviler.top/d/ecloud180/images/blogImage/NBJI4AQA5Y.png)

3）接近无限大线程数量的线程池

![img](http://alist.ciberviler.top/d/ecloud180/images/blogImage/4FJY4AQA3M.png)

4)带定时调度功能的线程池

![img](http://alist.ciberviler.top/d/ecloud180/images/blogImage/ZNJY4AQAQI.png)
