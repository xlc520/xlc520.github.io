<template><h1 id="spring-面试63问" tabindex="-1"><a class="header-anchor" href="#spring-面试63问" aria-hidden="true">#</a> Spring 面试63问</h1>
<ul>
<li>
<p>Sping原理</p>
...
<h3 id="spring-特点" tabindex="-1"><a class="header-anchor" href="#spring-特点" aria-hidden="true">#</a> Spring 特点</h3>
...
<h3 id="spring-框架优缺点" tabindex="-1"><a class="header-anchor" href="#spring-框架优缺点" aria-hidden="true">#</a> Spring 框架优缺点</h3>
...
<h3 id="spring-框架中都用到了哪些设计模式" tabindex="-1"><a class="header-anchor" href="#spring-框架中都用到了哪些设计模式" aria-hidden="true">#</a> Spring 框架中都用到了哪些设计模式</h3>
<p>Spring 框架中使用到了大量的设计模式，下面列举了比较有代表性的：</p>
<ul>
<li><code>代理模式</code>—在 AOP 和 remoting 中被用的比较多。</li>
<li><a href="https://blog.csdn.net/sufu1065/article/details/122872239" target="_blank" rel="noopener noreferrer"><code>单例模式</code><ExternalLinkIcon/></a>—在 spring 配置文件中定义的 bean 默认为单例模式。</li>
...
<h3 id="spring核心组件" tabindex="-1"><a class="header-anchor" href="#spring核心组件" aria-hidden="true">#</a> Spring核心组件</h3>
...
<h3 id="spring-控制反转-ioc" tabindex="-1"><a class="header-anchor" href="#spring-控制反转-ioc" aria-hidden="true">#</a> Spring 控制反转（IOC）</h3>
<h4 id="控制反转-ioc-概念" tabindex="-1"><a class="header-anchor" href="#控制反转-ioc-概念" aria-hidden="true">#</a> 控制反转（IOC）概念</h4>
...
<h4 id="spring-容器高层视图" tabindex="-1"><a class="header-anchor" href="#spring-容器高层视图" aria-hidden="true">#</a> Spring 容器高层视图</h4>
...
<h3 id="ioc-容器实现" tabindex="-1"><a class="header-anchor" href="#ioc-容器实现" aria-hidden="true">#</a> IOC 容器实现</h3>
<h4 id="beanfactory-框架基础设施" tabindex="-1"><a class="header-anchor" href="#beanfactory-框架基础设施" aria-hidden="true">#</a> BeanFactory-框架基础设施</h4>
...
<h3 id="applicationcontext-面向开发应用" tabindex="-1"><a class="header-anchor" href="#applicationcontext-面向开发应用" aria-hidden="true">#</a> ApplicationContext 面向开发应用</h3>
...
<p><img src="https://cdn.jsdelivr.net/gh/xlc520/MyImage/MdImg/9c9a78edbc6b9d2f3f849cbcfd3917ae.png" alt="9c9a78edbc6b9d2f3f849cbcfd3917ae.png" loading="lazy"></p>
<ul>
...
<h3 id="beanfactory-和-applicationcontext有什么区别" tabindex="-1"><a class="header-anchor" href="#beanfactory-和-applicationcontext有什么区别" aria-hidden="true">#</a> BeanFactory 和 ApplicationContext有什么区别？</h3>
<p>BeanFactory和ApplicationContext是Spring的两大核心接口，都可以当做Spring的容器。其中ApplicationContext是BeanFactory的子接口。</p>
<h4 id="依赖关系" tabindex="-1"><a class="header-anchor" href="#依赖关系" aria-hidden="true">#</a> 依赖关系</h4>
...
<h4 id="加载方式" tabindex="-1"><a class="header-anchor" href="#加载方式" aria-hidden="true">#</a> 加载方式</h4>
...
<h4 id="创建方式" tabindex="-1"><a class="header-anchor" href="#创建方式" aria-hidden="true">#</a> 创建方式</h4>
<p>BeanFactory通常以编程的方式被创建，ApplicationContext还能以声明的方式创建，如使用ContextLoader。</p>
<h4 id="注册方式" tabindex="-1"><a class="header-anchor" href="#注册方式" aria-hidden="true">#</a> 注册方式</h4>
...
<h4 id="applicationcontext通常的实现" tabindex="-1"><a class="header-anchor" href="#applicationcontext通常的实现" aria-hidden="true">#</a> ApplicationContext通常的实现</h4>
<ul>
...
<h3 id="spring的依赖注入" tabindex="-1"><a class="header-anchor" href="#spring的依赖注入" aria-hidden="true">#</a> Spring的依赖注入</h3>
...
<h4 id="依赖注入的基本原则" tabindex="-1"><a class="header-anchor" href="#依赖注入的基本原则" aria-hidden="true">#</a> 依赖注入的基本原则</h4>
...
<h3 id="构造器依赖注入和-setter方法注入的区别" tabindex="-1"><a class="header-anchor" href="#构造器依赖注入和-setter方法注入的区别" aria-hidden="true">#</a> 构造器依赖注入和 Setter方法注入的区别</h3>
<p><img src="https://cdn.jsdelivr.net/gh/xlc520/MyImage/MdImg/59c181416a4997b4f05d2446e3ff6f08.png" alt="59c181416a4997b4f05d2446e3ff6f08.png" loading="lazy"></p>
<p>两种依赖方式都可以使用，构造器注入和Setter方法注入。最好的解决方案是用构造器参数实现强制依赖，setter方法实现可选依赖。</p>
<h3 id="webapplication-体系架构" tabindex="-1"><a class="header-anchor" href="#webapplication-体系架构" aria-hidden="true">#</a> WebApplication 体系架构</h3>
...
<h3 id="spring-bean-定义" tabindex="-1"><a class="header-anchor" href="#spring-bean-定义" aria-hidden="true">#</a> Spring Bean 定义</h3>
...
<h3 id="spring-bean-作用域" tabindex="-1"><a class="header-anchor" href="#spring-bean-作用域" aria-hidden="true">#</a> Spring Bean 作用域</h3>
...
<h3 id="spring处理线程并发问题" tabindex="-1"><a class="header-anchor" href="#spring处理线程并发问题" aria-hidden="true">#</a> Spring处理线程并发问题</h3>
...
<h3 id="spring-bean-生命周期" tabindex="-1"><a class="header-anchor" href="#spring-bean-生命周期" aria-hidden="true">#</a> Spring Bean 生命周期</h3>
...
<h3 id="bean生命周期方法" tabindex="-1"><a class="header-anchor" href="#bean生命周期方法" aria-hidden="true">#</a> bean生命周期方法</h3>
...
</code></pre><div class="line-numbers" aria-hidden="true"><span class="line-number">1</span><br></div></div><h3 id="什么是spring的内部bean-什么是spring-inner-beans" tabindex="-1"><a class="header-anchor" href="#什么是spring的内部bean-什么是spring-inner-beans" aria-hidden="true">#</a> 什么是Spring的内部bean？什么是Spring inner beans？</h3>
...
<div class="language-go ext-go line-numbers-mode"><pre v-pre class="language-go"><code><span class="token comment">/*带参数，方便利用构造器进行注入*/</span>
...
</code></pre><div class="line-numbers" aria-hidden="true"><span class="line-number">1</span><br><span class="line-number">2</span><br><span class="line-number">3</span><br><span class="line-number">4</span><br><span class="line-number">5</span><br><span class="line-number">6</span><br><span class="line-number">7</span><br><span class="line-number">8</span><br><span class="line-number">9</span><br><span class="line-number">10</span><br><span class="line-number">11</span><br><span class="line-number">12</span><br><span class="line-number">13</span><br><span class="line-number">14</span><br><span class="line-number">15</span><br><span class="line-number">16</span><br><span class="line-number">17</span><br><span class="line-number">18</span><br><span class="line-number">19</span><br><span class="line-number">20</span><br><span class="line-number">21</span><br><span class="line-number">22</span><br><span class="line-number">23</span><br><span class="line-number">24</span><br><span class="line-number">25</span><br><span class="line-number">26</span><br><span class="line-number">27</span><br><span class="line-number">28</span><br><span class="line-number">29</span><br><span class="line-number">30</span><br><span class="line-number">31</span><br><span class="line-number">32</span><br><span class="line-number">33</span><br><span class="line-number">34</span><br><span class="line-number">35</span><br><span class="line-number">36</span><br><span class="line-number">37</span><br><span class="line-number">38</span><br><span class="line-number">39</span><br><span class="line-number">40</span><br><span class="line-number">41</span><br><span class="line-number">42</span><br></div></div><p>setter 方法注入</p>
<div class="language-go ext-go line-numbers-mode"><pre v-pre class="language-go"><code>public class Id <span class="token punctuation">{</span>
...
</code></pre><div class="line-numbers" aria-hidden="true"><span class="line-number">1</span><br><span class="line-number">2</span><br><span class="line-number">3</span><br><span class="line-number">4</span><br><span class="line-number">5</span><br><span class="line-number">6</span><br><span class="line-number">7</span><br><span class="line-number">8</span><br><span class="line-number">9</span><br><span class="line-number">10</span><br><span class="line-number">11</span><br><span class="line-number">12</span><br><span class="line-number">13</span><br><span class="line-number">14</span><br><span class="line-number">15</span><br><span class="line-number">16</span><br><span class="line-number">17</span><br><span class="line-number">18</span><br><span class="line-number">19</span><br><span class="line-number">20</span><br><span class="line-number">21</span><br><span class="line-number">22</span><br><span class="line-number">23</span><br><span class="line-number">24</span><br><span class="line-number">25</span><br><span class="line-number">26</span><br><span class="line-number">27</span><br><span class="line-number">28</span><br><span class="line-number">29</span><br><span class="line-number">30</span><br><span class="line-number">31</span><br><span class="line-number">32</span><br><span class="line-number">33</span><br><span class="line-number">34</span><br></div></div><p>静态工厂注入</p>
<p>静态工厂顾名思义，就是通过调用静态工厂的方法来获取自己需要的对象，为了让 spring 管理所有对象，我们不能直接通过&quot;工程类.静态方法()&quot;来获取对象，而是依然通过 spring 注入的形式获取：</p>
<div class="language-go ext-go line-numbers-mode"><pre v-pre class="language-go"><code>public class DaoFactory <span class="token punctuation">{</span> <span class="token comment">//静态工厂</span>
...
</code></pre><div class="line-numbers" aria-hidden="true"><span class="line-number">1</span><br><span class="line-number">2</span><br><span class="line-number">3</span><br><span class="line-number">4</span><br><span class="line-number">5</span><br><span class="line-number">6</span><br><span class="line-number">7</span><br><span class="line-number">8</span><br><span class="line-number">9</span><br><span class="line-number">10</span><br><span class="line-number">11</span><br><span class="line-number">12</span><br><span class="line-number">13</span><br><span class="line-number">14</span><br><span class="line-number">15</span><br><span class="line-number">16</span><br><span class="line-number">17</span><br><span class="line-number">18</span><br><span class="line-number">19</span><br><span class="line-number">20</span><br><span class="line-number">21</span><br><span class="line-number">22</span><br><span class="line-number">23</span><br><span class="line-number">24</span><br><span class="line-number">25</span><br><span class="line-number">26</span><br><span class="line-number">27</span><br><span class="line-number">28</span><br><span class="line-number">29</span><br><span class="line-number">30</span><br><span class="line-number">31</span><br><span class="line-number">32</span><br><span class="line-number">33</span><br><span class="line-number">34</span><br><span class="line-number">35</span><br><span class="line-number">36</span><br><span class="line-number">37</span><br><span class="line-number">38</span><br><span class="line-number">39</span><br><span class="line-number">40</span><br><span class="line-number">41</span><br><span class="line-number">42</span><br><span class="line-number">43</span><br><span class="line-number">44</span><br><span class="line-number">45</span><br><span class="line-number">46</span><br><span class="line-number">47</span><br><span class="line-number">48</span><br><span class="line-number">49</span><br><span class="line-number">50</span><br><span class="line-number">51</span><br><span class="line-number">52</span><br><span class="line-number">53</span><br><span class="line-number">54</span><br><span class="line-number">55</span><br><span class="line-number">56</span><br><span class="line-number">57</span><br><span class="line-number">58</span><br><span class="line-number">59</span><br><span class="line-number">60</span><br><span class="line-number">61</span><br><span class="line-number">62</span><br><span class="line-number">63</span><br><span class="line-number">64</span><br><span class="line-number">65</span><br><span class="line-number">66</span><br><span class="line-number">67</span><br><span class="line-number">68</span><br><span class="line-number">69</span><br><span class="line-number">70</span><br><span class="line-number">71</span><br><span class="line-number">72</span><br><span class="line-number">73</span><br><span class="line-number">74</span><br><span class="line-number">75</span><br><span class="line-number">76</span><br><span class="line-number">77</span><br><span class="line-number">78</span><br><span class="line-number">79</span><br><span class="line-number">80</span><br><span class="line-number">81</span><br><span class="line-number">82</span><br><span class="line-number">83</span><br><span class="line-number">84</span><br><span class="line-number">85</span><br><span class="line-number">86</span><br><span class="line-number">87</span><br><span class="line-number">88</span><br><span class="line-number">89</span><br><span class="line-number">90</span><br><span class="line-number">91</span><br><span class="line-number">92</span><br><span class="line-number">93</span><br><span class="line-number">94</span><br><span class="line-number">95</span><br><span class="line-number">96</span><br><span class="line-number">97</span><br><span class="line-number">98</span><br><span class="line-number">99</span><br><span class="line-number">100</span><br><span class="line-number">101</span><br><span class="line-number">102</span><br><span class="line-number">103</span><br><span class="line-number">104</span><br><span class="line-number">105</span><br><span class="line-number">106</span><br><span class="line-number">107</span><br><span class="line-number">108</span><br><span class="line-number">109</span><br><span class="line-number">110</span><br><span class="line-number">111</span><br><span class="line-number">112</span><br><span class="line-number">113</span><br><span class="line-number">114</span><br><span class="line-number">115</span><br><span class="line-number">116</span><br><span class="line-number">117</span><br><span class="line-number">118</span><br><span class="line-number">119</span><br><span class="line-number">120</span><br><span class="line-number">121</span><br><span class="line-number">122</span><br><span class="line-number">123</span><br><span class="line-number">124</span><br><span class="line-number">125</span><br><span class="line-number">126</span><br><span class="line-number">127</span><br><span class="line-number">128</span><br><span class="line-number">129</span><br><span class="line-number">130</span><br><span class="line-number">131</span><br><span class="line-number">132</span><br><span class="line-number">133</span><br><span class="line-number">134</span><br><span class="line-number">135</span><br><span class="line-number">136</span><br><span class="line-number">137</span><br><span class="line-number">138</span><br><span class="line-number">139</span><br><span class="line-number">140</span><br><span class="line-number">141</span><br><span class="line-number">142</span><br></div></div><h3 id="_5-种不同方式的自动装配" tabindex="-1"><a class="header-anchor" href="#_5-种不同方式的自动装配" aria-hidden="true">#</a> 5 种不同方式的自动装配</h3>
...
<h3 id="spring-中注入一个-java-collection" tabindex="-1"><a class="header-anchor" href="#spring-中注入一个-java-collection" aria-hidden="true">#</a> Spring 中注入一个 Java Collection</h3>
...
<div class="language-go ext-go line-numbers-mode"><pre v-pre class="language-go"><code><span class="token operator">&lt;</span>beans<span class="token operator">></span> 
...
</code></pre><div class="line-numbers" aria-hidden="true"><span class="line-number">1</span><br><span class="line-number">2</span><br><span class="line-number">3</span><br><span class="line-number">4</span><br><span class="line-number">5</span><br><span class="line-number">6</span><br><span class="line-number">7</span><br><span class="line-number">8</span><br><span class="line-number">9</span><br><span class="line-number">10</span><br><span class="line-number">11</span><br><span class="line-number">12</span><br><span class="line-number">13</span><br><span class="line-number">14</span><br><span class="line-number">15</span><br><span class="line-number">16</span><br><span class="line-number">17</span><br><span class="line-number">18</span><br><span class="line-number">19</span><br><span class="line-number">20</span><br><span class="line-number">21</span><br><span class="line-number">22</span><br><span class="line-number">23</span><br><span class="line-number">24</span><br><span class="line-number">25</span><br><span class="line-number">26</span><br><span class="line-number">27</span><br><span class="line-number">28</span><br><span class="line-number">29</span><br><span class="line-number">30</span><br><span class="line-number">31</span><br><span class="line-number">32</span><br><span class="line-number">33</span><br><span class="line-number">34</span><br><span class="line-number">35</span><br><span class="line-number">36</span><br><span class="line-number">37</span><br><span class="line-number">38</span><br><span class="line-number">39</span><br><span class="line-number">40</span><br><span class="line-number">41</span><br><span class="line-number">42</span><br><span class="line-number">43</span><br><span class="line-number">44</span><br><span class="line-number">45</span><br><span class="line-number">46</span><br><span class="line-number">47</span><br><span class="line-number">48</span><br><span class="line-number">49</span><br><span class="line-number">50</span><br><span class="line-number">51</span><br><span class="line-number">52</span><br><span class="line-number">53</span><br><span class="line-number">54</span><br><span class="line-number">55</span><br><span class="line-number">56</span><br><span class="line-number">57</span><br><span class="line-number">58</span><br><span class="line-number">59</span><br><span class="line-number">60</span><br><span class="line-number">61</span><br><span class="line-number">62</span><br><span class="line-number">63</span><br><span class="line-number">64</span><br><span class="line-number">65</span><br><span class="line-number">66</span><br><span class="line-number">67</span><br><span class="line-number">68</span><br><span class="line-number">69</span><br><span class="line-number">70</span><br><span class="line-number">71</span><br><span class="line-number">72</span><br><span class="line-number">73</span><br><span class="line-number">74</span><br><span class="line-number">75</span><br><span class="line-number">76</span><br><span class="line-number">77</span><br><span class="line-number">78</span><br><span class="line-number">79</span><br><span class="line-number">80</span><br><span class="line-number">81</span><br><span class="line-number">82</span><br><span class="line-number">83</span><br><span class="line-number">84</span><br><span class="line-number">85</span><br><span class="line-number">86</span><br><span class="line-number">87</span><br><span class="line-number">88</span><br><span class="line-number">89</span><br><span class="line-number">90</span><br><span class="line-number">91</span><br><span class="line-number">92</span><br><span class="line-number">93</span><br><span class="line-number">94</span><br><span class="line-number">95</span><br><span class="line-number">96</span><br><span class="line-number">97</span><br><span class="line-number">98</span><br><span class="line-number">99</span><br><span class="line-number">100</span><br><span class="line-number">101</span><br><span class="line-number">102</span><br><span class="line-number">103</span><br><span class="line-number">104</span><br><span class="line-number">105</span><br><span class="line-number">106</span><br><span class="line-number">107</span><br><span class="line-number">108</span><br><span class="line-number">109</span><br><span class="line-number">110</span><br><span class="line-number">111</span><br><span class="line-number">112</span><br><span class="line-number">113</span><br><span class="line-number">114</span><br><span class="line-number">115</span><br><span class="line-number">116</span><br><span class="line-number">117</span><br><span class="line-number">118</span><br><span class="line-number">119</span><br><span class="line-number">120</span><br><span class="line-number">121</span><br><span class="line-number">122</span><br><span class="line-number">123</span><br><span class="line-number">124</span><br><span class="line-number">125</span><br><span class="line-number">126</span><br><span class="line-number">127</span><br><span class="line-number">128</span><br><span class="line-number">129</span><br><span class="line-number">130</span><br><span class="line-number">131</span><br><span class="line-number">132</span><br><span class="line-number">133</span><br><span class="line-number">134</span><br><span class="line-number">135</span><br><span class="line-number">136</span><br><span class="line-number">137</span><br><span class="line-number">138</span><br><span class="line-number">139</span><br><span class="line-number">140</span><br><span class="line-number">141</span><br><span class="line-number">142</span><br><span class="line-number">143</span><br><span class="line-number">144</span><br><span class="line-number">145</span><br><span class="line-number">146</span><br><span class="line-number">147</span><br><span class="line-number">148</span><br><span class="line-number">149</span><br><span class="line-number">150</span><br><span class="line-number">151</span><br><span class="line-number">152</span><br><span class="line-number">153</span><br><span class="line-number">154</span><br><span class="line-number">155</span><br><span class="line-number">156</span><br><span class="line-number">157</span><br><span class="line-number">158</span><br><span class="line-number">159</span><br><span class="line-number">160</span><br><span class="line-number">161</span><br><span class="line-number">162</span><br><span class="line-number">163</span><br><span class="line-number">164</span><br><span class="line-number">165</span><br><span class="line-number">166</span><br><span class="line-number">167</span><br><span class="line-number">168</span><br><span class="line-number">169</span><br></div></div><h3 id="使用-autowired注解自动装配的过程" tabindex="-1"><a class="header-anchor" href="#使用-autowired注解自动装配的过程" aria-hidden="true">#</a> 使用@Autowired注解自动装配的过程</h3>
...
<h2 id="spring-aop" tabindex="-1"><a class="header-anchor" href="#spring-aop" aria-hidden="true">#</a> Spring AOP</h2>
<h3 id="aop原理" tabindex="-1"><a class="header-anchor" href="#aop原理" aria-hidden="true">#</a> AOP原理</h3>
...
<h3 id="aop-核心概念" tabindex="-1"><a class="header-anchor" href="#aop-核心概念" aria-hidden="true">#</a> AOP 核心概念</h3>
<ul>
...
<h3 id="spring-中的代理" tabindex="-1"><a class="header-anchor" href="#spring-中的代理" aria-hidden="true">#</a> Spring 中的代理</h3>
<p>将 Advice 应用于目标对象后创建的对象称为代理。在客户端对象的情况下，目标对象和代理对象是相同的。</p>
<blockquote>
<p>Advice + Target Object = Proxy</p>
</blockquote>
<h3 id="aop-实现方式" tabindex="-1"><a class="header-anchor" href="#aop-实现方式" aria-hidden="true">#</a> AOP 实现方式</h3>
...
<h3 id="aop-两种代理方式" tabindex="-1"><a class="header-anchor" href="#aop-两种代理方式" aria-hidden="true">#</a> AOP 两种代理方式</h3>
...
<h3 id="jdk-动态接口代理" tabindex="-1"><a class="header-anchor" href="#jdk-动态接口代理" aria-hidden="true">#</a> JDK 动态接口代理</h3>
...
<h3 id="cglib-动态代理" tabindex="-1"><a class="header-anchor" href="#cglib-动态代理" aria-hidden="true">#</a> CGLib 动态代理</h3>
...
<p>实现原理</p>
<div class="language-go ext-go line-numbers-mode"><pre v-pre class="language-go"><code>@Aspect
...
</code></pre><div class="line-numbers" aria-hidden="true"><span class="line-number">1</span><br><span class="line-number">2</span><br><span class="line-number">3</span><br><span class="line-number">4</span><br><span class="line-number">5</span><br><span class="line-number">6</span><br><span class="line-number">7</span><br><span class="line-number">8</span><br><span class="line-number">9</span><br><span class="line-number">10</span><br><span class="line-number">11</span><br><span class="line-number">12</span><br><span class="line-number">13</span><br><span class="line-number">14</span><br><span class="line-number">15</span><br><span class="line-number">16</span><br><span class="line-number">17</span><br><span class="line-number">18</span><br><span class="line-number">19</span><br><span class="line-number">20</span><br><span class="line-number">21</span><br><span class="line-number">22</span><br><span class="line-number">23</span><br><span class="line-number">24</span><br><span class="line-number">25</span><br><span class="line-number">26</span><br><span class="line-number">27</span><br><span class="line-number">28</span><br><span class="line-number">29</span><br><span class="line-number">30</span><br><span class="line-number">31</span><br><span class="line-number">32</span><br><span class="line-number">33</span><br><span class="line-number">34</span><br><span class="line-number">35</span><br><span class="line-number">36</span><br><span class="line-number">37</span><br><span class="line-number">38</span><br><span class="line-number">39</span><br><span class="line-number">40</span><br><span class="line-number">41</span><br><span class="line-number">42</span><br><span class="line-number">43</span><br><span class="line-number">44</span><br><span class="line-number">45</span><br><span class="line-number">46</span><br><span class="line-number">47</span><br><span class="line-number">48</span><br><span class="line-number">49</span><br><span class="line-number">50</span><br><span class="line-number">51</span><br><span class="line-number">52</span><br><span class="line-number">53</span><br><span class="line-number">54</span><br><span class="line-number">55</span><br><span class="line-number">56</span><br><span class="line-number">57</span><br><span class="line-number">58</span><br><span class="line-number">59</span><br><span class="line-number">60</span><br><span class="line-number">61</span><br><span class="line-number">62</span><br><span class="line-number">63</span><br><span class="line-number">64</span><br><span class="line-number">65</span><br><span class="line-number">66</span><br><span class="line-number">67</span><br><span class="line-number">68</span><br><span class="line-number">69</span><br><span class="line-number">70</span><br><span class="line-number">71</span><br><span class="line-number">72</span><br><span class="line-number">73</span><br><span class="line-number">74</span><br><span class="line-number">75</span><br><span class="line-number">76</span><br><span class="line-number">77</span><br><span class="line-number">78</span><br><span class="line-number">79</span><br><span class="line-number">80</span><br><span class="line-number">81</span><br><span class="line-number">82</span><br><span class="line-number">83</span><br><span class="line-number">84</span><br><span class="line-number">85</span><br><span class="line-number">86</span><br><span class="line-number">87</span><br><span class="line-number">88</span><br><span class="line-number">89</span><br><span class="line-number">90</span><br><span class="line-number">91</span><br><span class="line-number">92</span><br><span class="line-number">93</span><br><span class="line-number">94</span><br><span class="line-number">95</span><br><span class="line-number">96</span><br><span class="line-number">97</span><br><span class="line-number">98</span><br><span class="line-number">99</span><br><span class="line-number">100</span><br><span class="line-number">101</span><br><span class="line-number">102</span><br><span class="line-number">103</span><br><span class="line-number">104</span><br><span class="line-number">105</span><br><span class="line-number">106</span><br><span class="line-number">107</span><br><span class="line-number">108</span><br><span class="line-number">109</span><br><span class="line-number">110</span><br><span class="line-number">111</span><br><span class="line-number">112</span><br><span class="line-number">113</span><br><span class="line-number">114</span><br><span class="line-number">115</span><br><span class="line-number">116</span><br><span class="line-number">117</span><br><span class="line-number">118</span><br><span class="line-number">119</span><br><span class="line-number">120</span><br><span class="line-number">121</span><br><span class="line-number">122</span><br><span class="line-number">123</span><br><span class="line-number">124</span><br><span class="line-number">125</span><br><span class="line-number">126</span><br><span class="line-number">127</span><br><span class="line-number">128</span><br><span class="line-number">129</span><br><span class="line-number">130</span><br><span class="line-number">131</span><br><span class="line-number">132</span><br><span class="line-number">133</span><br><span class="line-number">134</span><br><span class="line-number">135</span><br><span class="line-number">136</span><br><span class="line-number">137</span><br><span class="line-number">138</span><br><span class="line-number">139</span><br></div></div><h3 id="spring在运行时通知对象" tabindex="-1"><a class="header-anchor" href="#spring在运行时通知对象" aria-hidden="true">#</a> Spring在运行时通知对象</h3>
...
<h3 id="spring只支持方法级别的连接点" tabindex="-1"><a class="header-anchor" href="#spring只支持方法级别的连接点" aria-hidden="true">#</a> Spring只支持方法级别的连接点</h3>
...
<h3 id="spring通知类型" tabindex="-1"><a class="header-anchor" href="#spring通知类型" aria-hidden="true">#</a> Spring通知类型</h3>
...
<h4 id="同一个aspect-不同advice的执行顺序" tabindex="-1"><a class="header-anchor" href="#同一个aspect-不同advice的执行顺序" aria-hidden="true">#</a> 同一个aspect，不同advice的执行顺序：</h4>
<p>没有异常情况下的执行顺序：</p>
<ul>
...
<h2 id="spring-mvc" tabindex="-1"><a class="header-anchor" href="#spring-mvc" aria-hidden="true">#</a> Spring MVC</h2>
<h3 id="spring-mvc-原理" tabindex="-1"><a class="header-anchor" href="#spring-mvc-原理" aria-hidden="true">#</a> Spring MVC 原理</h3>
...
<p><img src="https://cdn.jsdelivr.net/gh/xlc520/MyImage/MdImg/73ee5a65e7e6e8a0733e3730a486a6e8.png" alt="73ee5a65e7e6e8a0733e3730a486a6e8.png" loading="lazy"></p>
...
<h2 id="spring-data" tabindex="-1"><a class="header-anchor" href="#spring-data" aria-hidden="true">#</a> Spring DATA</h2>
<h3 id="spring-orm理解" tabindex="-1"><a class="header-anchor" href="#spring-orm理解" aria-hidden="true">#</a> Spring ORM理解</h3>
...
<h3 id="spring-dao-的支持" tabindex="-1"><a class="header-anchor" href="#spring-dao-的支持" aria-hidden="true">#</a> Spring DAO 的支持</h3>
<p>Spring DAO（数据访问对象） 使得 JDBC，Hibernate 或 JDO 这样的数据访问技术更容易以一种统一的方式工作。这使得用户容易在持久性技术之间切换。它还允许您在编写代码时，无需考虑捕获每种技术不同的异常。</p>
<h3 id="spring-jdbc-api" tabindex="-1"><a class="header-anchor" href="#spring-jdbc-api" aria-hidden="true">#</a> Spring JDBC API</h3>
<ul>
<li>JdbcTemplate</li>
...
<h3 id="jdbctemplate是什么" tabindex="-1"><a class="header-anchor" href="#jdbctemplate是什么" aria-hidden="true">#</a> JdbcTemplate是什么</h3>
<p>JdbcTemplate 类提供了很多便利的方法解决诸如把数据库数据转变成基本数据类型或对象，执行写好的或可调用的数据库操作语句，提供自定义的数据错误处理。</p>
<h3 id="使用spring通过什么方式访问hibernate" tabindex="-1"><a class="header-anchor" href="#使用spring通过什么方式访问hibernate" aria-hidden="true">#</a> 使用Spring通过什么方式访问Hibernate？</h3>
<p>有两种方式访问Hibernate：</p>
<ul>
<li>使用 Hibernate 模板和回调进行控制反转</li>
<li>扩展 HibernateDAOSupport 并应用 AOP 拦截器节点</li>
</ul>
<h3 id="spring-支持的-orm" tabindex="-1"><a class="header-anchor" href="#spring-支持的-orm" aria-hidden="true">#</a> Spring 支持的 ORM</h3>
<p>Spring 支持以下 ORM：</p>
<ul>
<li>Hibernate</li>
<li>iBatis</li>
...
<h3 id="spring-支持的事务管理类型" tabindex="-1"><a class="header-anchor" href="#spring-支持的事务管理类型" aria-hidden="true">#</a> Spring 支持的事务管理类型</h3>
...
<h3 id="spring-框架的事务管理有哪些优点" tabindex="-1"><a class="header-anchor" href="#spring-框架的事务管理有哪些优点" aria-hidden="true">#</a> Spring 框架的事务管理有哪些优点？</h3>
...
<h3 id="你更倾向用那种事务管理类型" tabindex="-1"><a class="header-anchor" href="#你更倾向用那种事务管理类型" aria-hidden="true">#</a> 你更倾向用那种事务管理类型？</h3>
<p>大多数 Spring 框架的用户选择声明式事务管理，因为它对应用代码的影响最小，因 此更符合一个无侵入的<a href="https://blog.csdn.net/sufu1065/article/details/122872239" target="_blank" rel="noopener noreferrer">轻量级容器<ExternalLinkIcon/></a>的思想。声明式事务管理要优于编程式事务管理， 虽然比编程式事务管理（这种方式允许你通过代码控制事务）少了一点灵活性。</p>
<h3 id="spring常用注解" tabindex="-1"><a class="header-anchor" href="#spring常用注解" aria-hidden="true">#</a> Spring常用注解</h3>
<h4 id="声明bean的注解" tabindex="-1"><a class="header-anchor" href="#声明bean的注解" aria-hidden="true">#</a> 声明bean的注解</h4>
<ul>
...
<h4 id="注入bean的注解" tabindex="-1"><a class="header-anchor" href="#注入bean的注解" aria-hidden="true">#</a> 注入bean的注解</h4>
<ul>
...
<h4 id="java配置类相关注解" tabindex="-1"><a class="header-anchor" href="#java配置类相关注解" aria-hidden="true">#</a> java配置类相关注解</h4>
<ul>
...
<h4 id="切面-aop-相关注解" tabindex="-1"><a class="header-anchor" href="#切面-aop-相关注解" aria-hidden="true">#</a> 切面（AOP）相关注解</h4>
...
<h3 id="bean的属性支持" tabindex="-1"><a class="header-anchor" href="#bean的属性支持" aria-hidden="true">#</a> @Bean的属性支持</h3>
...
<h3 id="value注解" tabindex="-1"><a class="header-anchor" href="#value注解" aria-hidden="true">#</a> @Value注解</h3>
...
<p>注入表达式结果</p>
<p><img src="https://cdn.jsdelivr.net/gh/xlc520/MyImage/MdImg/0a1da82128f379c30ad8a617633e8dbe.png" alt="0a1da82128f379c30ad8a617633e8dbe.png" loading="lazy"></p>
<p>注入其它bean属性</p>
<p><img src="https://cdn.jsdelivr.net/gh/xlc520/MyImage/MdImg/73e51190ca79d307501ca874efee2e3b.png" alt="73e51190ca79d307501ca874efee2e3b.png" loading="lazy"></p>
<p>注入文件资源</p>
...
<p>注入网站资源</p>
<p><img src="https://cdn.jsdelivr.net/gh/xlc520/MyImage/MdImg/cdaf29b32bdc7f7835aec018fecc3f50.png" alt="cdaf29b32bdc7f7835aec018fecc3f50.png" loading="lazy"></p>
<p>注入配置文件</p>
...
<h3 id="环境切换" tabindex="-1"><a class="header-anchor" href="#环境切换" aria-hidden="true">#</a> 环境切换</h3>
<ul>
...
<h3 id="异步相关" tabindex="-1"><a class="header-anchor" href="#异步相关" aria-hidden="true">#</a> 异步相关</h3>
<ul>
...
<h3 id="定时任务相关" tabindex="-1"><a class="header-anchor" href="#定时任务相关" aria-hidden="true">#</a> 定时任务相关</h3>
<ul>
...
<h3 id="enable-注解说明" tabindex="-1"><a class="header-anchor" href="#enable-注解说明" aria-hidden="true">#</a> @Enable 注解说明</h3>
...
<h3 id="测试相关注解" tabindex="-1"><a class="header-anchor" href="#测试相关注解" aria-hidden="true">#</a> 测试相关注解</h3>
<ul>
...
<h3 id="springmvc部分" tabindex="-1"><a class="header-anchor" href="#springmvc部分" aria-hidden="true">#</a> SpringMVC部分</h3>
<ul>
