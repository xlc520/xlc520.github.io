<template><h1 id="intellij-idea高效使用教程" tabindex="-1"><a class="header-anchor" href="#intellij-idea高效使用教程" aria-hidden="true">#</a> Intellij idea高效使用教程</h1>
<h2 id="一-安装插件" tabindex="-1"><a class="header-anchor" href="#一-安装插件" aria-hidden="true">#</a> 一. 安装插件</h2>
...
<h2 id="二-自定义创建live-template-快速写代码" tabindex="-1"><a class="header-anchor" href="#二-自定义创建live-template-快速写代码" aria-hidden="true">#</a> 二. 自定义创建live template，快速写代码</h2>
...
<h2 id="三-修改全局配置-提升工作效率" tabindex="-1"><a class="header-anchor" href="#三-修改全局配置-提升工作效率" aria-hidden="true">#</a> 三. 修改全局配置，提升工作效率</h2>
...
<h2 id="idea必备20款插件" tabindex="-1"><a class="header-anchor" href="#idea必备20款插件" aria-hidden="true">#</a> IDEA必备20款插件</h2>
<p>以下插件已经为大家下载打包了，如果IDEA版本不一致的话，部分插件可能无法安装，可以根据我提供的地址自行下载相应插件：
插件打包下载地址：https://www.lanzouw.com/iV3XKwvq2de</p>
<h3 id="leetcode-editor" tabindex="-1"><a class="header-anchor" href="#leetcode-editor" aria-hidden="true">#</a> Leetcode Editor</h3>
<p>这是一个上班摸鱼神器，也是一个可以在IDEA中刷算法题目的插件，有很多题目供我们学习，
表面在写代码，其实是在刷题。每道题都有很详细的解题思路
插件下载地址：https://plugins.jetbrains.com/plugin/12132-leetcode-editor</p>
<h3 id="jrebel" tabindex="-1"><a class="header-anchor" href="#jrebel" aria-hidden="true">#</a> Jrebel</h3>
...
https://jrebel.qekang.com/你生成的ID</p>
<h3 id="background-image-plus" tabindex="-1"><a class="header-anchor" href="#background-image-plus" aria-hidden="true">#</a> Background Image Plus</h3>
<p>一个设置背景图片的插件，有时候纯黑或者纯白看腻的话，可以使用这个插件自定义背景图片。
也支持动态的更换壁纸
插件下载地址：https://plugins.jetbrains.com/plugin/8502-background-image-plus</p>
<h3 id="codota" tabindex="-1"><a class="header-anchor" href="#codota" aria-hidden="true">#</a> Codota</h3>
...
<h3 id="easycode" tabindex="-1"><a class="header-anchor" href="#easycode" aria-hidden="true">#</a> EasyCode</h3>
...
插件下载地址：https://plugins.jetbrains.com/plugin/10954-easy-code</p>
<h3 id="translation" tabindex="-1"><a class="header-anchor" href="#translation" aria-hidden="true">#</a> Translation</h3>
<p>这是翻译插件，阅读源码有不认识的英文，或者编写变量时，不知道英文怎么写的时候可以直接进行翻译
在菜单栏上也可以直接进行翻译，不用再去打开一些在线翻译网站了
插件下载地址：https://plugins.jetbrains.com/plugin/8579-translation</p>
<h3 id="key-promoter-x" tabindex="-1"><a class="header-anchor" href="#key-promoter-x" aria-hidden="true">#</a> Key Promoter X</h3>
<p>一个可以让你慢慢脱离鼠标操作的插件，在IDEA中操作时，他会将对应的快捷键，进行提示。
并且右侧会有一个列表，将你近期使用的功能进行展示，对于高频操作我们可以使用快捷键，这样可以提升效率
插件下载地址：https://plugins.jetbrains.com/plugin/9792-key-promoter-x</p>
<h3 id="maven-helper" tabindex="-1"><a class="header-anchor" href="#maven-helper" aria-hidden="true">#</a> Maven Helper</h3>
<p>插件下载地址：https://plugins.jetbrains.com/plugin/7179-maven-helper
...
<h3 id="alibaba-java-coding-guidelines" tabindex="-1"><a class="header-anchor" href="#alibaba-java-coding-guidelines" aria-hidden="true">#</a> Alibaba Java Coding Guidelines</h3>
<p>阿里巴巴开发的一款插件，可以扫描代码中可能存在的问题
插件下载地址：https://plugins.jetbrains.com/plugin/10046-alibaba-java-coding-guidelines</p>
<p>将不符合规约的代码按 Blocker/Critical/Major(崩溃/严重/重要 ) 三个等级显示在下方，双击可以定位至代码处，右侧窗口还有针对代码的批量修复功能。</p>
<h3 id="codeglance" tabindex="-1"><a class="header-anchor" href="#codeglance" aria-hidden="true">#</a> CodeGlance</h3>
<p>用过sublime的同学对这个功能一定很熟悉，它是一个迷你缩放图插件
当代码过长的时候可以使用这个插件，相比如下拉框，这个插件更加的直观和方便
插件下载地址：https://plugins.jetbrains.com/plugin/7275-codeglance</p>
<h3 id="gsonformat" tabindex="-1"><a class="header-anchor" href="#gsonformat" aria-hidden="true">#</a> GsonFormat</h3>
<p>这是一个将Json字符串自动转换成实体类的插件
安装完插件之后，在实体类中使用快捷键 'alt+insert'，mac是‘control + 回车’选择GsonFormat
插件下载地址：https://plugins.jetbrains.com/plugin/7654-gsonformat</p>
<h3 id="javadoc" tabindex="-1"><a class="header-anchor" href="#javadoc" aria-hidden="true">#</a> JavaDoc</h3>
<p>这是一个快速生成文档注释的插件
插件下载地址：https://plugins.jetbrains.com/plugin/7157-javadoc
windows上可以通过alt + insert 快捷键，mac是control+回车
可以快速生成注释模板</p>
<h3 id="ignore" tabindex="-1"><a class="header-anchor" href="#ignore" aria-hidden="true">#</a> ignore</h3>
...
<h3 id="rainbow-brackets" tabindex="-1"><a class="header-anchor" href="#rainbow-brackets" aria-hidden="true">#</a> Rainbow Brackets</h3>
<p>这个插件主要是让我们代码中的括号变成彩虹颜色的括号，除了好看还可以帮我们分清括号，防止错乱
插件下载地址：https://plugins.jetbrains.com/plugin/10080-rainbow-brackets</p>
<h3 id="acejump" tabindex="-1"><a class="header-anchor" href="#acejump" aria-hidden="true">#</a> AceJump</h3>
<p>插件下载地址：https://plugins.jetbrains.com/plugin/7086-acejump
...
并且支持各种各样的请求类型</p>
<h3 id="material-theme-ui" tabindex="-1"><a class="header-anchor" href="#material-theme-ui" aria-hidden="true">#</a> Material Theme UI</h3>
<p>插件下载地址：https://plugins.jetbrains.com/plugin/8006-material-theme-ui
这是一款不错的主题插件，颜值非常的高，安装之后重启即可生效
可以在设置中，对一些细节，比如调整字体、大小、行间距等</p>
<h3 id="generateallsetter" tabindex="-1"><a class="header-anchor" href="#generateallsetter" aria-hidden="true">#</a> GenerateAllSetter</h3>
<p>插件下载地址：https://plugins.jetbrains.com/plugin/9360-generateallsetter/versions
...
<h3 id="statistic" tabindex="-1"><a class="header-anchor" href="#statistic" aria-hidden="true">#</a> Statistic</h3>
<p>一款分析项目代码的工具，按照扩展名列出清单，统计代码数量和行数
点击具体的类别，比如Java，可以统计总行数，有效代码行数，注释行数，以及有效代码比重
插件下载地址：https://plugins.jetbrains.com/plugin/4509-statistic</p>
<h3 id="free-mybatis-plugin" tabindex="-1"><a class="header-anchor" href="#free-mybatis-plugin" aria-hidden="true">#</a> Free MyBatis plugin</h3>
<p>插件下载地址：https://plugins.jetbrains.com/plugin/8321-free-mybatis-plugin
在使用mybatis时，它可以通过mapper接口中的方法，直接跳转到mapper.xml文件中，
同样也可以从mapper.xml跳转到mapper接口中
非常实用！</p>
<h3 id="stop-coding" tabindex="-1"><a class="header-anchor" href="#stop-coding" aria-hidden="true">#</a> Stop Coding</h3>
<p>插件下载地址：https://plugins.jetbrains.com/plugin/15740-stopcoding
