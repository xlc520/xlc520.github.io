import {
  ...
  defineComponent,
  h
} from "./chunk-5Z32AEIP.js";
import "./chunk-D5PC226R.js";
import {
  __spreadProps,
  __spreadValues,
...
import "E:/source/Git/vuepress-hope-v2/node_modules/@mr-hope/vuepress-shared/lib/client/styles/message.scss";
...
var c = u.exports = function() {
  ...
  }, _2 = function t2(e2, n2, r3) {
    var i3;
    if (!e2)
      return g2;
    if (typeof e2 == "string") {
      var s3 = e2.toLowerCase();
      M2[s3] && (i3 = s3), n2 && (M2[s3] = n2, i3 = s3);
      var o3 = e2.split("-");
      if (!i3 && o3.length > 1)
        return t2(o3[0]);
    } else {
