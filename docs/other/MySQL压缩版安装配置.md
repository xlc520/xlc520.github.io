...
- 旧版本中存在漏洞
- ![image-20220115155838758](static/img/image-20220115155838758.png)
...
![img](static/img/watermark,type_ZmFuZ3poZW5naGVpdGk,shadow_10,text_aHR0cHM6Ly9ibG9nLmNzZG4ubmV0L3dlaXhpbl80NDU3NzU0Mw==,size_16,color_FFFFFF,t_70.png)
...
![img](static/img/watermark,type_ZmFuZ3poZW5naGVpdGk,shadow_10,text_aHR0cHM6Ly9ibG9nLmNzZG4ubmV0L3UwMTQ3MjIwMjI=,size_16,color_FFFFFF,t_70.png)
...
![img](static/img/1780812-20190829212537656-1187829463.png)

 7.执行`net start mysql`启动服务（执行`net stop mysql`关闭服务）

![img](static/img/1780812-20190829212232857-537058421.png)
...
![img](static/img/20200131203311761.png)

解决办法：
下载vcruntime140_1.dll，链接：https://cn.dll-files.com/vcruntime140_1.dll.html

![在这里插入图片描述](static/img/watermark,type_ZmFuZ3poZW5naGVpdGk,shadow_10,text_aHR0cHM6Ly9ibG9nLmNzZG4ubmV0L3dlaXhpbl80NDU3NzU0Mw==,size_16,color_FFFFFF,t_70-16422331874666.png)
下载完成后，解压提取文件，将提取出来的`vcruntime140_1.dll`文件复制到我们的`C:\Windows\System32`
![在这里插入图片描述](static/img/watermark,type_ZmFuZ3poZW5naGVpdGk,shadow_10,text_aHR0cHM6Ly9ibG9nLmNzZG4ubmV0L3dlaXhpbl80NDU3NzU0Mw==,size_16,color_FFFFFF,t_70-16422331874677.png)
...
```
 ...
 ![img](static/img/20200303112518670.png)
...
![img](static/img/20190831112741174.png)
