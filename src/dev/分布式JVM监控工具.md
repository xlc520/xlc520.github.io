...
![分布式JVM监控工具](https://static.linch.eu.org/blogImage/t_70-16533795511054.png)

## 整体架构

![分布式JVM监控工具](https://static.linch.eu.org/blogImage/t_70-16533795511055.png)
...
![分布式JVM监控工具](https://static.linch.eu.org/blogImage/t_70-16533795511051.png)

### idea -> Project from Existing Sources…

![分布式JVM监控工具](https://static.linch.eu.org/blogImage/t_70-16533795511052.png)

### 选中项目pom.xml

![分布式JVM监控工具](https://static.linch.eu.org/blogImage/t_70-16533795511053.png)

### 修改resources/application.properties

![分布式JVM监控工具](https://static.linch.eu.org/blogImage/t_70-16533795511064.png)
...
![分布式JVM监控工具](https://static.linch.eu.org/blogImage/t_70-16533795511065.png)
...
![分布式JVM监控工具](https://static.linch.eu.org/blogImage/t_70-16533795511066.png)

### 进入Release列表，下载jar

![分布式JVM监控工具](https://static.linch.eu.org/blogImage/t_70-16533795511067.png)
...
![分布式JVM监控工具](https://static.linch.eu.org/blogImage/t_70-16533795511068.png)

### 在任意一个Spring boot项目中使用，我这里打开我本地一个叫chat的项目

![分布式JVM监控工具](https://static.linch.eu.org/blogImage/t_70-16533795511069.png)
...
![分布式JVM监控工具](https://static.linch.eu.org/blogImage/t_70-165337955110610.png)

### pom.xml引入

![分布式JVM监控工具](https://static.linch.eu.org/blogImage/t_70-165337955110611.png)

### 跑起项目

![分布式JVM监控工具](https://static.linch.eu.org/blogImage/t_70-165337955110612.png)
OK！

### 我们现在访问monitor-server(我当下部署的在http://127.0.0.1:8888,大家根据自己的配置访问)

![分布式JVM监控工具](https://static.linch.eu.org/blogImage/t_70-165337955110613.png)