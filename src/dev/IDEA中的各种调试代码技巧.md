...
![IDEA调试](https://static.xlc520.ml/blogImage/640-16567524343880.png)

在设置里勾选Show debug window on breakpoint，则请求进入到断点后自动激活Debug

![IDEA调试](https://static.xlc520.ml/blogImage/640-16567524343881.png)

如果你的IDEA底部没有显示工具栏或状态栏，可以在View里打开，显示出工具栏会方便我们使用。可以自己去尝试下这四个选项。

![IDEA调试](https://static.xlc520.ml/blogImage/640-16567524343882.png)

在菜单栏Run里有调试对应的功能，同时可以查看对应的快捷键。

![IDEA调试](https://static.xlc520.ml/blogImage/640-16567524343883.png)
...
![IDEA调试](https://static.xlc520.ml/blogImage/640-16567524343884.png)
...
2、第二组按钮，共7个按钮，从上到下依次如下：
 ...
 ![IDEA调试](https://static.xlc520.ml/blogImage/640-16567524343885.png) 
...
![IDEA调试](https://static.xlc520.ml/blogImage/640-16567524343886.png)

![IDEA调试](https://static.xlc520.ml/blogImage/640-16567524343887.png)
...
![IDEA调试](https://static.xlc520.ml/blogImage/640-16567524343888.png)

2、光标悬停到参数上，显示当前变量信息。点击打开详情如图3.3。我一般会使用这种方式，快捷方便。

![IDEA调试](https://static.xlc520.ml/blogImage/640-16567524343899.png)

![IDEA调试](https://static.xlc520.ml/blogImage/640-165675243438910.png)

3、在Variables里查看，这里显示当前方法里的所有变量。

![IDEA调试](https://static.xlc520.ml/blogImage/640-165675243438911.png)

4、在Watches里，点击New Watch，输入需要查看的变量。或者可以从Variables里拖到Watche里查看。

![IDEA调试](https://static.xlc520.ml/blogImage/640-165675243438912.png)

如果你发现你没有Watches，可能在下图所在的地方。

![IDEA调试](https://static.xlc520.ml/blogImage/640-165675243438913.png) 
![IDEA调试](https://static.xlc520.ml/blogImage/640-165675243438914.png)

## 四、计算表达式

在前面提到的计算表达式如图4.1的按钮，Evaluate Expression (Alt + F8) 。可以使用这个操作在调试过程中计算某个表达式的值，而不用再去打印信息。

![IDEA调试](https://static.xlc520.ml/blogImage/640-165675243438915.png)

1、按Alt + F8或按钮，或者，你可以选中某个表达式再Alt + F8，弹出计算表达式的窗口，如下，回车或点击Evaluate计算表达式的值。

这个表达式不仅可以是一般变量或参数，也可以是方法，当你的一行代码中调用了几个方法时，就可以通过这种方式查看查看某个方法的返回值。

![IDEA调试](https://static.xlc520.ml/blogImage/640-165675243438916.png)

2、设置变量，在计算表达式的框里，可以改变变量的值，这样有时候就能很方便我们去调试各种值的情况了不是。

![IDEA调试](https://static.xlc520.ml/blogImage/640-165675243438917.png)
...
![IDEA调试](https://static.xlc520.ml/blogImage/640-165675243438918.png)

按Shift + F7，会自动定位到当前断点行，并列出需要进入的方法，如图5.2，点击方法进入方法内部。

如果只有一个方法，则直接进入，类似Force Step Into。

![IDEA调试](https://static.xlc520.ml/blogImage/640-165675243438919.png)
...
![IDEA调试](https://static.xlc520.ml/blogImage/640-165675243438920.png)
...
![IDEA调试](https://static.xlc520.ml/blogImage/640-165675243438921.png)

![IDEA调试](https://static.xlc520.ml/blogImage/640-165675243438922.png)
...
![IDEA调试](https://static.xlc520.ml/blogImage/640-165675243438923.png) 

![IDEA调试](https://static.xlc520.ml/blogImage/640-165675243439024.png)
...
![IDEA调试](https://static.xlc520.ml/blogImage/640-165675243439025.png)

![IDEA调试](https://static.xlc520.ml/blogImage/640-165675243439026.png) 
![IDEA调试](https://static.xlc520.ml/blogImage/640-165675243439027.png)
...
![IDEA调试](https://static.xlc520.ml/blogImage/640-165675243439028.png)

切换线程，在图7.2中Frames的下拉列表里，可以切换当前的线程，如下我这里有两个Debug的线程，切换另外一个则进入另一个Debug的线程。

![IDEA调试](https://static.xlc520.ml/blogImage/640-165675243439029.png)
...
![IDEA调试](https://static.xlc520.ml/blogImage/640-165675243439030.png)
...
![IDEA调试](https://static.xlc520.ml/blogImage/640-165675243439031.png)

![IDEA调试](https://static.xlc520.ml/blogImage/640-165675243439032.png)

![IDEA调试](https://static.xlc520.ml/blogImage/640-165675243439033.png)
...
![IDEA调试](https://static.xlc520.ml/blogImage/640-165675243439034.png)

![IDEA调试](https://static.xlc520.ml/blogImage/640-165675243439035.png)
...
![IDEA调试](https://static.xlc520.ml/blogImage/640-165675243439036.png)

![IDEA调试](https://static.xlc520.ml/blogImage/640-165675243439037.png)

![IDEA调试](https://static.xlc520.ml/blogImage/640-165675243439038.png)
