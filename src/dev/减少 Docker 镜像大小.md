...
如下图所示，带有 new 标签的镜像由于添加了此标志而减少了 5MB。当我们要安装多个包时，这将非常有帮助。![图片](https://static.xlc520.ml/blogImage/640-1679364162221-0.png)
...
![图片](https://static.xlc520.ml/blogImage/640-1679364162221-1.png)
