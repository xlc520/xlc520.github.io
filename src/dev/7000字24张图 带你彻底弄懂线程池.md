...
![img](https://static.linch.eu.org/blogImage/MBJI4AQAPA.png)
...
![img](https://static.linch.eu.org/blogImage/MBJI4AQA3M.png)
...
![img](https://static.linch.eu.org/blogImage/DJKI4AQAQI.png)
...
![img](https://static.linch.eu.org/blogImage/CNJY4AQAW4.png)

当任务执行完之后，线程不会退出，而是会去从阻塞队列中获取任务，如下图

![img](https://static.linch.eu.org/blogImage/EFJY4AQALI.png)
...
![img](https://static.linch.eu.org/blogImage/MJJI4AQAKA.png)
...
![img](https://static.linch.eu.org/blogImage/MJJI4AQA4I.png)
...
![img](https://static.linch.eu.org/blogImage/MNJI4AQA5Y.jpeg)
...
![img](https://static.linch.eu.org/blogImage/HBJY4AQA3M.png)
...
![img](https://static.linch.eu.org/blogImage/IJJY4AQADE.png)
...
![img](https://static.linch.eu.org/blogImage/K5JY4AQAW4.png)
...
![img](https://static.linch.eu.org/blogImage/MRJI4AQA7A.jpeg)
...
![img](https://static.linch.eu.org/blogImage/MVJI4AQARI.jpeg)
...
![img](https://static.linch.eu.org/blogImage/UVJY4AQARI.png)

### 六、线程池的5种状态

线程池内部有5个常量来代表线程池的五种状态

![img](https://static.linch.eu.org/blogImage/VRJY4AQAWU.png)
...
![img](https://static.linch.eu.org/blogImage/MZJI4AQA3M.png)
...
![img](https://static.linch.eu.org/blogImage/M5JI4AQA2Q.png)

就是将线程池的状态修改为`SHUTDOWN`，然后尝试打断空闲的线程（如何判断空闲，上面在说Worker继承AQS的时候说过），也就是在阻塞等待任务的线程。

##### **shutdownNow方法**

![img](https://static.linch.eu.org/blogImage/M5JI4AQA7A.png)
...
![img](https://static.linch.eu.org/blogImage/NBJI4AQA3M.png)

2）单个线程数量的线程池

![img](https://static.linch.eu.org/blogImage/NBJI4AQA5Y.png)

3）接近无限大线程数量的线程池

![img](https://static.linch.eu.org/blogImage/4FJY4AQA3M.png)

4)带定时调度功能的线程池

![img](https://static.linch.eu.org/blogImage/ZNJY4AQAQI.png)
