...
![图片](https://static.xlc520.ml/blogImage/640-1674302588592-1.png)

### 3. idea设置成eclipse的快捷键

这对eclipse转idea的开发人员来说 非常友好，这样不需要记两套快捷键

![图片](https://static.xlc520.ml/blogImage/640-1674302588592-2.png)

### 4. 设置提示词忽略大小写

把这个勾去掉，（有的idea版本是选择选项 选择none即可），例如String 输入string 、String 都可以提示

![图片](https://static.xlc520.ml/blogImage/640-1674302588592-3.png)

### 5. 关闭代码检查

与eclipse类似，idea也可以自己关闭代码检查 减少资源使用，但不推荐全部关闭，（是大佬当我没说），把我们项目中不会使用到的关闭就好了

![图片](https://static.xlc520.ml/blogImage/640-1674302588592-4.png)
...
![图片](https://static.xlc520.ml/blogImage/640-1674302588592-5.png)

### 8.设置多行tab

idea默认是选择显示单行的，我们把这个去掉，就可以显示多行tab了，在打开tab过多时的场景非常方便！

![图片](https://static.xlc520.ml/blogImage/640-1674302588593-6.png)

![图片](https://static.xlc520.ml/blogImage/640-1674302588593-7.png)
...
![图片](https://static.xlc520.ml/blogImage/640-1674302588593-8.png)
...
![图片](https://static.xlc520.ml/blogImage/640-1674302588593-9.png)
...
![图片](https://static.xlc520.ml/blogImage/640-1674302588593-10.png)

### 13.查看方法在哪里被调用

`ctrl+alt+h` 可以清楚看到方法在哪些地方被调用；在知道这个快捷键之前，都是`ctrl+h`（idea默认 `ctrl+shift+f`）搜索，肉眼找的…

![图片](https://static.xlc520.ml/blogImage/640-1674302588593-11.png)

### 14.代码模板（代码快捷键）

例如 : eclipse 中的syso是打印控制台输出 ，但是idea默认是sout , 如果非要改成syso 可以在`Postfix Completion`里面设置，类似的 fori等都是在里面设置

![图片](https://static.xlc520.ml/blogImage/640-1674302588593-12.png)

### 15.自动导包、自动移除没用的包

![图片](https://static.xlc520.ml/blogImage/640-1674302588593-13.png)
...
![图片](https://static.xlc520.ml/blogImage/640-1674302588593-14.png)
...
![图片](https://static.xlc520.ml/blogImage/640-1674302588593-15.png)

### 19. 微服务项目中 将不同项目添加到同一个启动窗口

![图片](https://static.xlc520.ml/blogImage/640-1674302588593-16.png)

步骤：`View` ——>`Tool Windows` ——> `services` ——>`add services`

![图片](https://static.xlc520.ml/blogImage/640-1674302588594-17.png)

### 20. idea全局设置 （打开新窗口的设置）

例如我们打开新窗口时，maven配置会恢复 这时就需要对打开新窗口的设置进行修改 达到一个全局的目的。

![图片](https://static.xlc520.ml/blogImage/640-1674302588594-18.png)
...
![图片](https://static.xlc520.ml/blogImage/640-1674302588594-19.png)
...
![图片](https://static.xlc520.ml/blogImage/640-1674302588594-20.png)

### 23. maven tree （查看maven jar包依赖关系）

如果是使用 `mvn dependency:tree` 命令 , 结果是下图这样 很不方便查看

![图片](https://static.xlc520.ml/blogImage/640-1674302588594-21.png)

我们可以在idea右上角点击这个`ShowDependencies`按钮 以图片形式展示出来 图片按住ctrl和鼠标滑轮 可以放大，这个在排除依赖冲突 查看jar包来源时 非常好用

![图片](https://static.xlc520.ml/blogImage/640-1674302588594-22.png)

有的时候 可能莫名其妙看不到这个图标 ，我们可以点一下设置

![图片](https://static.xlc520.ml/blogImage/640-1674302588594-23.png)

把这个勾上，它就能显示了，等显示后，再把这个勾去掉

![图片](https://static.xlc520.ml/blogImage/640-1674302588594-24.png)
...
![图片](https://static.xlc520.ml/blogImage/640-1674302588594-25.png)
...
![图片](https://static.xlc520.ml/blogImage/640-1674302588594-26.png)

- 第二步：开启ssh会话

![图片](https://static.xlc520.ml/blogImage/640-1674302588594-27.png)
...
![图片](https://static.xlc520.ml/blogImage/640-1674302588594-28.png)

在要查看的java文件鼠标右键，点击 `Sequence Diagram`

![图片](https://static.xlc520.ml/blogImage/640-1674302588594-29.png)

效果示例：

![图片](https://static.xlc520.ml/blogImage/640-1674302588594-30.png)
...
![图片](https://static.xlc520.ml/blogImage/640-1674302588594-31.png)

当我们把run方法改成`start()`方法时，可以看到是线程thread0执行的。

![图片](https://static.xlc520.ml/blogImage/640-1674302588595-32.png)
...
![图片](https://static.xlc520.ml/blogImage/640-1674302588595-33.png)