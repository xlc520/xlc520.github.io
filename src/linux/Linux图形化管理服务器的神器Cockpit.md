...
![Cockpit](https://static.linch.eu.org/blogImage/20220513101207.png)

之后，您应该会看到如下界面：

![Cockpit](https://static.linch.eu.org/blogImage/20220513101224.png)
...
![Cockpit](https://static.linch.eu.org/blogImage/20220513101239.png)
...
![Cockpit](https://static.linch.eu.org/blogImage/20220513101256.png)
...
![Cockpit](https://static.linch.eu.org/blogImage/20220513101310.png)
...
![Cockpit](https://static.linch.eu.org/blogImage/20220513101323.png)
...
![Cockpit](https://static.linch.eu.org/blogImage/20220513101337.png)
...
![Cockpit](https://static.linch.eu.org/blogImage/20220513101351.png)
...
![Cockpit](https://static.linch.eu.org/blogImage/20220513101411.png)

## **系统状态监控**

如果您想要更简单的实时统计概览，您可以转至仪表板。

![Cockpit](https://static.linch.eu.org/blogImage/20220513101430.png)

统计信息分为四个基本选项卡：CPU、内存、网络和磁盘 I/O。

![Cockpit](https://static.linch.eu.org/blogImage/20220513101544.png)

![Cockpit](https://static.linch.eu.org/blogImage/20220513101556.png)

![Cockpit](https://static.linch.eu.org/blogImage/20220513101721.png)

![Cockpit](https://static.linch.eu.org/blogImage/20220513101728.png)

### 添加 SSH 密钥

在右上角，单击您的用户名，然后单击“身份验证”。

![Cockpit](https://static.linch.eu.org/blogImage/20220513101744.png)

如果您的 SSH 密钥位于其默认位置，则会自动检测到它，否则，您需要手动添加并启用它。这与您通过终端使用的 SSH 配置相同。如果您在本地使用 SSH 密码，则必须在单击下面显示的按钮后输入该密码。

![Cockpit](https://static.linch.eu.org/blogImage/20220513101810.png)
...
![Cockpit](https://static.linch.eu.org/blogImage/20220513101824.png)

要添加机器，而不是上面提到的 9090，您必须使用与远程服务器上相同的 SSH 端口号。默认情况下，它是 22。

![Cockpit](https://static.linch.eu.org/blogImage/20220513101842.png)

单击“添加”后，您可能会收到如下错误：

![Cockpit](https://static.linch.eu.org/blogImage/20220513101852.png)

这是因为，Cockpit 正在尝试使用与远程服务器的当前系统相同的凭据。在同一错误页面上（如上图所示），您可以将用户名更改为远程服务器可识别的名称。

完成此操作并单击登录后，将添加您的远程服务器。

![Cockpit](https://static.linch.eu.org/blogImage/20220513101906.png)

## **从 Cockpit 中删除服务器**

要删除已添加的服务器，您需要单击“编辑服务器”图标：

![Cockpit](https://static.linch.eu.org/blogImage/20220513101920.png)

单击后，您可以删除标记为红色的添加服务器，另一个是灰色的，因为您无法删除当前连接的服务器。

![Cockpit](https://static.linch.eu.org/blogImage/20220513101934.png)
