...
  导出步骤tools ->export user object，选择要导出的对象，导出.sql格式文件并等待导出完成，如 下图：
 ...
 ![image-20220620092932901](https://static.linch.eu.org/blogImage/image-20220620092932901.png)
...
![image-20220620092943308](https://static.linch.eu.org/blogImage/image-20220620092943308.png)

导出为sql格式，如下图： 

![image-20220620092949353](https://static.linch.eu.org/blogImage/image-20220620092949353.png)

导出为pde格式，如下图： 

![image-20220620092954469](https://static.linch.eu.org/blogImage/image-20220620092954469.png)
