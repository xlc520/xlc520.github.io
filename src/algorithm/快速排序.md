...
![图片](https://static.linch.eu.org/blogImage/978b84a9b541a0db3b191993bc9fbd62.png)
...
![图片](https://static.linch.eu.org/blogImage/47163d859bc7517570716e1853e67ebb.png)

**二、**
num[last]<key交换元素后，转向左边部分，用num[first]与key进行比较，如果num[first]<key,则++first，然后继续进行比较，直至num[first]>key,则将num[last]=num[first]。

![图片](https://static.linch.eu.org/blogImage/41a9849c2ee0619ca10dca2f0c942251.png)
![图片](https://static.linch.eu.org/blogImage/c3098c79e69a9547ce8996b310ebf296.png)

**三、**
重复上述一二步骤

![图片](https://static.linch.eu.org/blogImage/1e415f1728b314dfc9cd1c90b1dcd9af.png)

![图片](https://static.linch.eu.org/blogImage/ea40064bf09b7cce290866b0b47061aa.png)
![图片](https://static.linch.eu.org/blogImage/50a1d73bad725027a2029378d10fbe8d.png)
![图片](https://static.linch.eu.org/blogImage/a958b26d073c9bb0028b7a789934edfc.png)
![图片](https://static.linch.eu.org/blogImage/9d32ef4a4b40b025e3d1c55793e6b168.png)
![图片](https://static.linch.eu.org/blogImage/f9094712d3320eba982b4afe01b9eaa5.png)
![图片](https://static.linch.eu.org/blogImage/4f16335e5225369f133a2c93a70efcf4.png)
![图片](https://static.linch.eu.org/blogImage/a0b398c6f9c2600cc551a4e21b35ccf4.png)
![图片](https://static.linch.eu.org/blogImage/4c1e553a89a57abe4ceaf726d7f52924.png)
...
![img](https://static.linch.eu.org/blogImage/d53f8794a4c27d1ecff02604e5162266dfc43863.png)

![img](https://static.linch.eu.org/blogImage/8b82b9014a90f60307aca9253bd63c13b151ed84.png)

![img](https://static.linch.eu.org/blogImage/7aec54e736d12f2e95af5d264e065a6a8435681e.png)
...
![img](https://static.linch.eu.org/blogImage/quickSort.gif)

## 四、算法性能分析

**最好情况**
每次数据元素都能平均的分成两个部分。得到一个完全二叉树。如果有n个数据元素，那么数的深度为
![图片](https://static.linch.eu.org/blogImage/cc536403e247bf6f9b83d29d2ab656ae.png)
时间复杂度为O(nlogn)
