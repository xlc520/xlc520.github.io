...
![image-20220424103625642](https://static.xlc520.ml/blogImage/6341d7a797684a31ae2e6f567c9057fd.png)

下面是根据综合得分对大学进行排名：

![image-20220424103843298](https://static.xlc520.ml/blogImage/d2d1f6a92aca95da78de2198ce021a3d.png)

### 1.3 常见的排序算法

![image-20220424104112902](https://static.xlc520.ml/blogImage/800519b135762278631075369f949b9c.png)
...
![20210223174254141](https://static.xlc520.ml/blogImage/627d7b9813a49e036cd717b3d60b50d0.gif)
...
![v2-f9616f6892819e579a2d4ab10256a732_b](https://static.xlc520.ml/blogImage/76f44ea58c9e4af381670fe28e1ce217.gif)

1、**预排序：大的数更快的到后面去，小的数更快的到前面去，尽可能地接近有序。**

举例：

![image-20220417091054918](https://static.xlc520.ml/blogImage/78da1877163e9f0987a1f73d42667a0f.png)
...
>
![image-20220417092754508](https://static.xlc520.ml/blogImage/3660714e7c614d97bbee9b2d7f7c2352.png)
>
...
>    《数据结构(C语言版)》— 严蔚敏
>
![image-20220417104317401](https://static.xlc520.ml/blogImage/5b8e5ee2709631acece6763009ed51c5.png)
>
>    《数据结构-用面相对象方法与C++描述》— 殷人昆
>
![image-20220417104337855](https://static.xlc520.ml/blogImage/11267f038cd6ddce4e0cfcd02e5a9a0b.png)
>
...
![SEL](https://static.xlc520.ml/blogImage/a2c7cbf6ea0c17a87a4b0831d7c60cec.gif)
...
![1145616330](https://static.xlc520.ml/blogImage/8b8b46206ecca895870276ca5149d2c1.gif)
...
1. **hoare版本**
   ...
   ![hoare](https://static.xlc520.ml/blogImage/e2ef543195516b5ef4c44adc5eabce70.gif)

   图像展示：

   ![image-20220417161341875](https://static.xlc520.ml/blogImage/20fadbe0e8794591ce048476c67ef15a.png)
   ...
   答：第一轮排序后如图所示：
   ![image-20220417170238685](https://static.xlc520.ml/blogImage/b5d1140514dca8c0ff1931e554984ee9.png)
...
2. 挖坑法
   ...
   ![挖坑法](https://static.xlc520.ml/blogImage/2ffc140a0e4bf8d13f559eb0fbe6345a.gif)
...
3. 前后指针法
   ...
   ![前后指针](https://static.xlc520.ml/blogImage/6a192f147c7020e2f75021611f0eadfc.gif)
...
![image-20220419170635866](https://static.xlc520.ml/blogImage/822e6a187d4fc340de2346382edcff5e.png)
...
![image-20220419192053842](https://static.xlc520.ml/blogImage/1a67e55fa6d320383e8a72b03a386d1f.png)
...
![image-20220422195516422](https://static.xlc520.ml/blogImage/079858f522d812594312eab72b433dcb.png)
...
![image-20220422204533821](https://static.xlc520.ml/blogImage/f0c813bb9c8eccf06e81e5e78dddb445.png)
...
![image-20220422210059119](https://static.xlc520.ml/blogImage/409b11fc280352b94999019532a04a6b.png)

![查看源图像](https://static.xlc520.ml/blogImage/982cc6fad502de29d4af238100569cdf.gif)
...
![image-20220423161317000](https://static.xlc520.ml/blogImage/c82035cdcc62be64dedd60a1668eddec.png)

归并思路：

![image-20220423162141519](https://static.xlc520.ml/blogImage/4ac55bc76b4845fd6ccfeeca35191d92.png)
...
![image-20220423185520974](https://static.xlc520.ml/blogImage/2f5e6483ad4313ba5adaedf519b4a551.png)
...
![image-20220423190011161](https://static.xlc520.ml/blogImage/0c096d16fb242c92fbe5abb24b518524.png)
...
1. 归并思路如下图所示：
   ...
   ![image-20220425150548589](https://static.xlc520.ml/blogImage/fd64f57d8edc5f293c35abcfd1fff68f.png)
...
2. 时间复杂度：O(N*logN)
   如何理解归并排序的时间复杂度？
   ![image-20220423205120424](https://static.xlc520.ml/blogImage/57c171c5539166024671fba819d5533b.png)
3. 空间复杂度：O(N)
...
![image-20220423221717247](https://static.xlc520.ml/blogImage/272d7fcd1c7f55637c2cdbcb574d25f2.png)

当N为100000时：

![image-20220423221808048](https://static.xlc520.ml/blogImage/84905c3c406f63c1d0094334b37d5394.png)

此时继续进行测试快速排序、堆排序、希尔排序、归并排序：

当N为1000000：

![image-20220423221907517](https://static.xlc520.ml/blogImage/e793df554c6fe4802b1d8760d8b8a427.png)

当N为10000000：

![image-20220423221948756](https://static.xlc520.ml/blogImage/45545554598f0000996cfaba74b5f33e.png)

当N为20000000：

![image-20220423222352147](https://static.xlc520.ml/blogImage/e466a1ec3265678865ceea33d613a66e.png)
...
图示：
![image-20220424121029857](https://static.xlc520.ml/blogImage/8ff0ea2f54b5a345787eb2ac52513ed3.png)
...
![image-20220424150445356](https://static.xlc520.ml/blogImage/06054fbb0eb0066e3dc1bbb5aff69b55.png)
...
![image-20220424150957648](https://static.xlc520.ml/blogImage/e715fdf6491b319305f1d9e11e4a008e.png)

在上图中，选出最小的数字1，和前面的3交换之后两个3的相对位置就发生了交换，说明选择排序是不稳定的。

堆排序：不稳定。如下图所示：

![image-20220424151402859](https://static.xlc520.ml/blogImage/7382f7031da7b403a9057df9f74a81d3.png)
