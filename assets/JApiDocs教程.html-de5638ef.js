import{_ as r}from"./plugin-vue_export-helper-c27b6911.js";import{r as s,o as l,c as t,b as e,d as i,e as a,a as d}from"./app-21243f18.js";const c={},o=d(`<h1 id="japidocs教程" tabindex="-1"><a class="header-anchor" href="#japidocs教程" aria-hidden="true">#</a> JApiDocs教程</h1><p>一、Maven依赖</p><div class="language-text line-numbers-mode" data-ext="text"><pre class="language-text"><code>&lt;!--  JApiDocs  --&gt;
&lt;dependency&gt;
   &lt;groupId&gt;io.github.yedaxia&lt;/groupId&gt;
   &lt;artifactId&gt;japidocs&lt;/artifactId&gt;
   &lt;version&gt;1.4.3&lt;/version&gt;
&lt;/dependency&gt;
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h2 id="二、代码规范" tabindex="-1"><a class="header-anchor" href="#二、代码规范" aria-hidden="true">#</a> 二、代码规范</h2><h3 id="_1-分组名称-description" tabindex="-1"><a class="header-anchor" href="#_1-分组名称-description" aria-hidden="true">#</a> 1. 分组名称 @description</h3><p><em>注：官方文档中注明分组名称@description，但是实际应用中不需要加入注解，像下例所示，直接写注释即可。（类上写不写都行，方法上如果加上@description反而不显示）</em><br> 例：</p><div class="language-text line-numbers-mode" data-ext="text"><pre class="language-text"><code>/**
 * 用户接口
 */
/*注意：这里不能空行，否则注释名无法显示*/
@RequestMapping(&quot;test&quot;)
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h3 id="_3-返回对象" tabindex="-1"><a class="header-anchor" href="#_3-返回对象" aria-hidden="true">#</a> 3. 返回对象</h3><h4 id="_1-restcontroller-或-responsebody" tabindex="-1"><a class="header-anchor" href="#_1-restcontroller-或-responsebody" aria-hidden="true">#</a> （1）@RestController 或 @ResponseBody</h4><p>返回json数据类型<br> 例：</p><div class="language-text line-numbers-mode" data-ext="text"><pre class="language-text"><code>/**
 * 用户接口
 */
@RequestMapping(&quot;/test&quot;)
@RestController
