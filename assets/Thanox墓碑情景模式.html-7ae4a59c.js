import{_ as e,W as o,X as p,Z as n,$ as s,a0 as t,Y as i,C as u}from"./framework-3ab8bde0.js";const c={},l=n("h1",{id:"thanox墓碑情景模式",tabindex:"-1"},[n("a",{class:"header-anchor",href:"#thanox墓碑情景模式","aria-hidden":"true"},"#"),s(" Thanox墓碑情景模式")],-1),r=n("h2",{id:"最终合并2022-06-06",tabindex:"-1"},[n("a",{class:"header-anchor",href:"#最终合并2022-06-06","aria-hidden":"true"},"#"),s(" 最终合并2022.06.06")],-1),d=n("p",null,"分为两个版本，普通版和音频焦点版，根据自己需求选一个",-1),v={href:"https://github.com/myflavor/NoANR/releases/",target:"_blank",rel:"noopener noreferrer"},k={href:"https://coolstars.lanzoum.com/in97305v6ewj",target:"_blank",rel:"noopener noreferrer"},q={href:"https://github.com/Tornaco/Thanox/releases",target:"_blank",rel:"noopener noreferrer"},m={href:"https://xlc.lanzouh.com/ixU2G062x56d",target:"_blank",rel:"noopener noreferrer"},b=i(`<h3 id="普通版" tabindex="-1"><a class="header-anchor" href="#普通版" aria-hidden="true">#</a> 普通版</h3><div class="language-json line-numbers-mode" data-ext="json"><pre class="language-json"><code><span class="token punctuation">[</span>
...
<span class="token punctuation">]</span>
    ...
    <span class="token punctuation">}</span>
<span class="token punctuation">]</span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div>`,41);function g(h,y){const a=u("ExternalLinkIcon");return o(),p("div",null,[l,r,d,n("p",null,[s("搭配"),n("a",v,[s("NoANR(点击下载)"),t(a)])]),n("p",null,[n("a",k,[s("Thanox3.9.9(点击下载)"),t(a)]),n("a",q,[s("github"),t(a)])]),n("p",null,[n("a",m,[s("Thanox3.9.9row"),t(a)])]),b])}const x=e(c,[["render",g],["__file","Thanox墓碑情景模式.html.vue"]]);export{x as default};
