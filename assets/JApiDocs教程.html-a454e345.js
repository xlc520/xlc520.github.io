import{_ as d}from"./plugin-vue_export-helper-c27b6911.js";import{r as s,o as r,c as l,b as i,d as e,e as t,a as n}from"./app-a8514216.js";const c={},o=n(`<h1 id="japidocs教程" tabindex="-1"><a class="header-anchor" href="#japidocs教程" aria-hidden="true">#</a> JApiDocs教程</h1><p>一、Maven依赖</p><div class="language-text line-numbers-mode" data-ext="text"><pre class="language-text"><code>&lt;!--  JApiDocs  --&gt;
&lt;dependency&gt;
 ...
 * @Version 1.0
 */
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>具体如何实现自定义方法注释，类注释。可以参考下面的文章：</p><blockquote><p>https://blog.csdn.net/qq_38675373/article/details/105886922</p></blockquote><p>JApiDocs官方文档地址：</p><blockquote><p>https://japidocs.agilestudio.cn/#/</p></blockquote>`,28);function h(p,m){const a=s("ExternalLinkIcon");return r(),l("div",null,[o,i("p",null,[e("可以通过 "),i("a",u,[e("pandoc"),t(a)]),e(" 把 markdown 格式转成 pdf 或者 word 格式。")]),v])}const x=d(c,[["render",h],["__file","JApiDocs教程.html.vue"]]);export{x as default};
