...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>如果日志中没有出现任何 401 或者访问拒绝的内容，说明服务一切正常。</p><h3 id="使用-kibana-控制台" tabindex="-1"><a class="header-anchor" href="#使用-kibana-控制台" aria-hidden="true">#</a> 使用 Kibana 控制台</h3><p>启动之后，我们使用浏览器访问服务器IP+端口5601，打开 kibana 控制台。</p><p><img src="http://122.9.159.116:5244/d/ecloud180/images/blogImage/v2-6e81c345d57b1ed67e834c655a3082e0_r.jpg" alt="img"></p><p>使用elastic 账号和密码登录后，就能够看到 Kibana 的界面了，如果第一次使用，会看到欢迎界面。</p><p><img src="http://122.9.159.116:5244/d/ecloud180/images/blogImage/v2-30151461a0b7a7412a7063e446439074_r.jpg" alt="img"></p><p>在登陆之后，第一次使用，可以考虑导入示例数据，来帮助了解 Kibana 的基础功能。</p><p><img src="http://122.9.159.116:5244/d/ecloud180/images/blogImage/v2-b0ea3bd33d02838d4e15d0787a7a4659_r.jpg" alt="img"></p><p>接下来就是自由探索的过程了，: )</p><p><img src="http://122.9.159.116:5244/d/ecloud180/images/blogImage/v2-c97fac3f23e7d384ba71843dfdfe64d7_r.jpg" alt="img"></p><h3 id="关闭付费组件" tabindex="-1"><a class="header-anchor" href="#关闭付费组件" aria-hidden="true">#</a> 关闭付费组件</h3><p>打开设置界面，选择 Elasticsearch 模块中的 License Management ，可以看到默认软件会启动为期一个月的高级功能试用。</p><p><img src="http://122.9.159.116:5244/d/ecloud180/images/blogImage/v2-423450e256c5e034f24a9aa2ca0494b6_r.jpg" alt="img"></p>`,15),g={href:"https://www.elastic.co/cn/subscriptions",target:"_blank",rel:"noopener noreferrer"},h=t(`<p><img src="http://122.9.159.116:5244/d/ecloud180/images/blogImage/v2-7aa7bf6822c363babdb3cb1eee874383_r.jpg" alt="img"></p><p>如果你想要了解软件当前运行状态，除了登陆机器，查看宿主机和容器状态外，在监控界面，我们也可以方便快捷的看到单节点中各个服务的运行状态和资源占用。</p><p><img src="http://122.9.159.116:5244/d/ecloud180/images/blogImage/v2-36d9b830184f14f9e36e03943150c3e9_r.jpg" alt="img"></p><p>选择“Revert to Basic license”，选择回退到基础版本，可以看到整个界面都简洁了不少，至此如果不付费的话，就可以安心合法的使用软件了。</p><p><img src="http://122.9.159.116:5244/d/ecloud180/images/blogImage/v2-7303bb065fbfdf67f66064f7a9d9246f_r.jpg" alt="img"></p><p>当然，你也可以在 elasticsearch.yml 配置文件中的 <code>xpack.license.self_generated.type</code> 修改为 <code>basic</code> 来禁用 X-Pack 相关功能。</p><div class="language-text line-numbers-mode" data-ext="text"><pre class="language-text"><code>xpack.license.self_generated.type: basic
