...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h3 id="模拟2000003-条数据进行测试" tabindex="-1"><a class="header-anchor" href="#模拟2000003-条数据进行测试" aria-hidden="true">#</a> 模拟2000003 条数据进行测试</h3><p><img src="http://122.9.159.116:5244/d/ecloud180/images/blogImage/20191225121702208.png" alt="img"></p><p>多线程 测试 2000003 耗时如下：耗时1.67分钟</p><p><img src="http://122.9.159.116:5244/d/ecloud180/images/blogImage/2019122512171971.png" alt="img"></p><p><img src="http://122.9.159.116:5244/d/ecloud180/images/blogImage/20191225121745132.png" alt="img"></p><p>本次开启30个线程，截图如下：</p><p><img src="http://122.9.159.116:5244/d/ecloud180/images/blogImage/20191225121812550.png" alt="img"></p><p>单线程测试2000003 耗时如下：耗时5.75分钟</p><p><img src="http://122.9.159.116:5244/d/ecloud180/images/blogImage/20191225121832495.png" alt="img"></p><p><img src="http://122.9.159.116:5244/d/ecloud180/images/blogImage/20191225121848593.png" alt="img"></p><h3 id="检查多线程入库的数据-检查是否存在重复入库的问题" tabindex="-1"><a class="header-anchor" href="#检查多线程入库的数据-检查是否存在重复入库的问题" aria-hidden="true">#</a> 检查多线程入库的数据，检查是否存在重复入库的问题：</h3><p>根据id分组，查看是否有id重复的数据，通过sql语句检查，没有发现重复入库的问题</p><p><img src="http://122.9.159.116:5244/d/ecloud180/images/blogImage/2019122512191274.png" alt="img"></p><p>检查数据完整性： 通过sql语句查询，多线程录入数据完整 <img src="http://122.9.159.116:5244/d/ecloud180/images/blogImage/20191225122051393.png" alt="img"></p><h2 id="测试结果" tabindex="-1"><a class="header-anchor" href="#测试结果" aria-hidden="true">#</a> 测试结果</h2><p>不同线程数测试：</p><p><img src="http://122.9.159.116:5244/d/ecloud180/images/blogImage/2019122512213611.png" alt="img"></p><p><img src="https://img-blog.csdnimg.cn/20191225122203925.png" alt="img"></p><h2 id="总结" tabindex="-1"><a class="header-anchor" href="#总结" aria-hidden="true">#</a> 总结</h2><p>通过以上测试案列，同样是导入2000003 条数据，多线程耗时1.67分钟，单线程耗时5.75分钟。通过对不同线程数的测试，发现不是线程数越多越好，具体多少合适，网上有一个不成文的算法：</p>`,34),i=[p];function c(o,l){return s(),a("div",null,i)}const d=n(t,[["render",c],["__file","Springboot利用ThreadPoolTaskExecutor多线程批量插入百万级数据.html.vue"]]);export{d as default};
