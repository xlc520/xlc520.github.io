...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div></div></div><p><code>Oracle</code> 镜像文件比较大，请检查自己磁盘空间。此处用一个博主上传的镜像，来演示。</p><figure><img src="https://static.xlc520.ml/blogImage/55b32c05eba117fc562fc792bc4f4e48.png" alt="20220726155418" tabindex="0" loading="lazy"><figcaption>20220726155418</figcaption></figure><h4 id="_2-3-拉取镜像" tabindex="-1"><a class="header-anchor" href="#_2-3-拉取镜像" aria-hidden="true">#</a> 2.3. 拉取镜像</h4><div class="language-linux line-numbers-mode" data-ext="linux"><pre class="language-linux"><code>docker pull registry.cn-hangzhou.aliyuncs.com/helowin/oracle_11g
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div></div></div><h4 id="_3-3-环境设置" tabindex="-1"><a class="header-anchor" href="#_3-3-环境设置" aria-hidden="true">#</a> 3.3. 环境设置</h4><p>此时 <code>sqlplus</code> 是不可以用的，需要配置一下环境变量。</p><figure><img src="https://static.xlc520.ml/blogImage/9a34b3e6187fe82094f7098c412e6d04.png" alt="20220726163736" tabindex="0" loading="lazy"><figcaption>20220726163736</figcaption></figure><p>切换回到容器中的 <code>root</code> 用户，密码为 <code>helowin</code> 。</p><h4 id="_3-3-1-编辑环境变量" tabindex="-1"><a class="header-anchor" href="#_3-3-1-编辑环境变量" aria-hidden="true">#</a> 3.3.1. 编辑环境变量</h4>`,35),p={href:"https://download.csdn.net/download/mmc_maodun/6970951",target:"_blank",rel:"noopener noreferrer"},u=n("img",{src:"https://static.xlc520.ml/blogImage/star.png",alt:"img",loading:"lazy"},null,-1),m=n("img",{src:"https://static.xlc520.ml/blogImage/arrowDownWhite.png",alt:"img",loading:"lazy"},null,-1),v=s(`<div class="language-bash line-numbers-mode" data-ext="sh"><pre class="language-bash"><code><span class="token function">vi</span> /etc/profile
...
conn /as sysdba
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div></div></div><figure><img src="https://static.xlc520.ml/blogImage/406b808f765627beab8bc6268aa7a23f.png" alt="20220726194234" tabindex="0" loading="lazy"><figcaption>20220726194234</figcaption></figure><h4 id="_3-5-oracle操作" tabindex="-1"><a class="header-anchor" href="#_3-5-oracle操作" aria-hidden="true">#</a> 3.5. Oracle操作</h4><h4 id="_3-5-1-修改sys、system用户密码" tabindex="-1"><a class="header-anchor" href="#_3-5-1-修改sys、system用户密码" aria-hidden="true">#</a> 3.5.1. 修改sys、system用户密码</h4><div class="language-sql line-numbers-mode" data-ext="sql"><pre class="language-sql"><code><span class="token keyword">alter</span> <span class="token keyword">user</span> system identified <span class="token keyword">by</span> system <span class="token punctuation">;</span><span class="token comment">--修改system用户账号密码；</span>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div></div></div>`,15),b={href:"https://download.csdn.net/download/weiwei1988815/5500567",target:"_blank",rel:"noopener noreferrer"},k=n("img",{src:"https://static.xlc520.ml/blogImage/star.png",alt:"img",loading:"lazy"},null,-1),h=n("img",{src:"https://static.xlc520.ml/blogImage/arrowDownWhite.png",alt:"img",loading:"lazy"},null,-1),g=s(`<h4 id="_3-5-2-添加和授权用户" tabindex="-1"><a class="header-anchor" href="#_3-5-2-添加和授权用户" aria-hidden="true">#</a> 3.5.2. 添加和授权用户</h4><div class="language-sql line-numbers-mode" data-ext="sql"><pre class="language-sql"><code><span class="token keyword">create</span> <span class="token keyword">user</span> test identified <span class="token keyword">by</span> test<span class="token punctuation">;</span> <span class="token comment">-- 创建内部管理员账号密码；</span>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><figure><img src="https://static.xlc520.ml/blogImage/0fc4a051c1a40e4f9bbc034534553497.png" alt="20220726194844" tabindex="0" loading="lazy"><figcaption>20220726194844</figcaption></figure><h3 id="_4-远程登录" tabindex="-1"><a class="header-anchor" href="#_4-远程登录" aria-hidden="true">#</a> 4. 远程登录</h3><ul><li>HOST: $HOST</li><li>POST: 1521</li><li>SID: helowin</li><li>User: test</li><li>PassWord：test</li></ul><figure><img src="https://static.xlc520.ml/blogImage/90628c41e2934c62baf062d8cf60f3ed.png" alt="20220726194951" tabindex="0" loading="lazy"><figcaption>20220726194951</figcaption></figure><h2 id="通过docker-安装oracle12c" tabindex="-1"><a class="header-anchor" href="#通过docker-安装oracle12c" aria-hidden="true">#</a> 通过Docker 安装Oracle12C</h2><div class="language-yaml line-numbers-mode" data-ext="yml"><pre class="language-yaml"><code><span class="token key atrule">version</span><span class="token punctuation">:</span> <span class="token string">&quot;3.6&quot;</span>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div></div></div><figure><img src="https://static.xlc520.ml/blogImage/2031bd4759e54c4c9dd4249ab2e29eee.png" alt="在这里插入图片描述" tabindex="0" loading="lazy"><figcaption>在这里插入图片描述</figcaption></figure>`,28),_={id:"第二步-创建挂载文件",tabindex:"-1"},y=n("a",{class:"header-anchor",href:"#第二步-创建挂载文件","aria-hidden":"true"},"#",-1),f={href:"https://so.csdn.net/so/search?q=%E6%8C%82%E8%BD%BD&spm=1001.2101.3001.7020",target:"_blank",rel:"noopener noreferrer"},x=s(`<div class="language-bash line-numbers-mode" data-ext="sh"><pre class="language-bash"><code><span class="token comment"># 创建文件</span>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div></div></div><p>如果你在安装的时候没有设置密码的话</p><p>oracle有三个默认的用户名和密码</p><p>1.用户名:sys密码:change_on_install</p><p>2.用户名:system密码:manager</p><p>3.用户名:scott密码:tiger</p>`,24);function w(A,L){const e=r("ExternalLinkIcon");return c(),t("div",null,[o,n("p",null,[n("a",p,[a("优化冒泡排序和选择排序zip"),u,a("0星超过10%的资源595KB"),m,a("下载"),i(e)])]),v,n("p",null,[n("a",b,[a("冒泡排序和选择法排序的源代码c"),k,a("0星超过10%的资源712.0B"),h,a("下载"),i(e)])]),g,n("h3",_,[y,a(" 第二步：创建"),n("a",f,[a("挂载"),i(e)]),a("文件")]),x,n("p",null,[a("还可以通过访问"),n("a",E,[a("https://localhost:5502/em"),i(e)])]),O])}const q=l(d,[["render",w],["__file","Docker安装Oracle.html.vue"]]);export{q as default};
