import{_ as n}from"./_plugin-vue_export-helper.cdc0426e.js";import{o as s,c as a,d as t}from"./app.8f077891.js";const p={},e=t(`<h1 id="_1-新组件" tabindex="-1"><a class="header-anchor" href="#_1-新组件" aria-hidden="true">#</a> 1. 新组件</h1><h2 id="_1-fragment-片断" tabindex="-1"><a class="header-anchor" href="#_1-fragment-片断" aria-hidden="true">#</a> 1) Fragment(片断)</h2><ul><li>在Vue2中: 组件必须有一个根标签</li><li>在Vue3中: 组件可以没有根标签, 内部会将多个标签包含在一个Fragment虚拟元素中</li><li>好处: 减少标签层级, 减小内存占用</li></ul><div class="language-vue line-numbers-mode" data-ext="vue"><pre class="language-vue"><code><span class="token tag"><span class="token tag"><span class="token punctuation">&lt;</span>template</span><span class="token punctuation">&gt;</span></span>
