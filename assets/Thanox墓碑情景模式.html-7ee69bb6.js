import{_ as e}from"./plugin-vue_export-helper-c27b6911.js";import{r as o,o as p,c as i,b as n,d as s,e as t,a as u}from"./app-865676a6.js";const c={},l=n("h1",{id:"thanox墓碑情景模式",tabindex:"-1"},[n("a",{class:"header-anchor",href:"#thanox墓碑情景模式","aria-hidden":"true"},"#"),s(" Thanox墓碑情景模式")],-1),r=n("h2",{id:"最终合并2022-06-06",tabindex:"-1"},[n("a",{class:"header-anchor",href:"#最终合并2022-06-06","aria-hidden":"true"},"#"),s(" 最终合并2022.06.06")],-1),d=n("p",null,"分为两个版本，普通版和音频焦点版，根据自己需求选一个",-1),v={href:"https://github.com/myflavor/NoANR/releases/",target:"_blank",rel:"noopener noreferrer"},k={href:"https://coolstars.lanzoum.com/in97305v6ewj",target:"_blank",rel:"noopener noreferrer"},q=n("br",null,null,-1),m={href:"https://github.com/Tornaco/Thanox/releases",target:"_blank",rel:"noopener noreferrer"},b={href:"https://xlc.lanzouh.com/ixU2G062x56d",target:"_blank",rel:"noopener noreferrer"},g=u(`<h3 id="普通版" tabindex="-1"><a class="header-anchor" href="#普通版" aria-hidden="true">#</a> 普通版</h3><div class="language-json line-numbers-mode" data-ext="json"><pre class="language-json"><code><span class="token punctuation">[</span>
...
<span class="token punctuation">]</span>
    ...
    <span class="token punctuation">}</span>
<span class="token punctuation">]</span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>冻结有两个版本，一个普通版，一个跳过音频焦点版（获得音频焦点的应用不会被冻结，大部分音乐播放器在播放的时候都会获取音频焦点，暂停时取消焦点，部分流氓APP暂停不会取消音频焦点，由于是从shell取的值，可能部分机子会有问题？）<br> 全局变量whiteApps可添加白名单APP跳过墓碑仅乖巧</p><h3 id="普通版-1" tabindex="-1"><a class="header-anchor" href="#普通版-1" aria-hidden="true">#</a> 普通版</h3><div class="language-json line-numbers-mode" data-ext="json"><pre class="language-json"><code><span class="token punctuation">[</span>
    <span class="token punctuation">{</span>
...
<span class="token punctuation">]</span>
    ...
    <span class="token punctuation">}</span>
<span class="token punctuation">]</span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div>`,41);function h(y,f){const a=o("ExternalLinkIcon");return p(),i("div",null,[l,r,d,n("p",null,[s("搭配"),n("a",v,[s("NoANR(点击下载)"),t(a)])]),n("p",null,[n("a",k,[s("Thanox3.9.9(点击下载)"),t(a)]),q,n("a",m,[s("github"),t(a)])]),n("p",null,[n("a",b,[s("Thanox3.9.9row"),t(a)])]),g])}const A=e(c,[["render",h],["__file","Thanox墓碑情景模式.html.vue"]]);export{A as default};
