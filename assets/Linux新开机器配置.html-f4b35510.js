import{_ as i,W as c,X as r,Y as n,Z as e,a0 as a,$ as t,C as o}from"./framework-06fee4ab.js";const l={},u=t(`<h1 id="linux新开机器配置" tabindex="-1"><a class="header-anchor" href="#linux新开机器配置" aria-hidden="true">#</a> Linux新开机器配置</h1><h2 id="_1-更换yum-apt源" tabindex="-1"><a class="header-anchor" href="#_1-更换yum-apt源" aria-hidden="true">#</a> 1.更换yum/apt源</h2><blockquote><p><strong>通知：CentOS 8操作系统版本结束了生命周期（EOL），Linux社区已不再维护该操作系统版本。建议您切换到Anolis或Alinux。如果您的业务过渡期仍需要使用CentOS 8系统中的一些安装包，请根据下文切换CentOS 8的源。</strong></p></blockquote><h3 id="centos" tabindex="-1"><a class="header-anchor" href="#centos" aria-hidden="true">#</a> CentOS</h3><h4 id="_1-备份" tabindex="-1"><a class="header-anchor" href="#_1-备份" aria-hidden="true">#</a> 1. 备份</h4><div class="language-text line-numbers-mode" data-ext="text"><pre class="language-text"><code>mv /etc/yum.repos.d/CentOS-Base.repo /etc/yum.repos.d/CentOS-Base.repo.backup
