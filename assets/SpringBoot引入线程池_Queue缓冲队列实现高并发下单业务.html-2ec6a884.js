import{_ as d,V as l,W as r,X as e,Y as i,$ as a,Z as n,E as v}from"./framework-debd98b7.js";const u={},t=n(`<h1 id="springboot-引入线程池-queue缓冲队列实现高并发下单业务" tabindex="-1"><a class="header-anchor" href="#springboot-引入线程池-queue缓冲队列实现高并发下单业务" aria-hidden="true">#</a> SpringBoot 引入线程池+Queue缓冲队列实现高并发下单业务</h1><ul><li>1.首先是springBoot的项目框架如下：</li><li>2.业务测试流程涉及的类，如下</li><li>3.使用JMeter模拟并发下单请求</li><li>4.结果</li></ul><hr><p>主要是自己在项目中(中小型项目) 有支付下单业务(只是办理VIP，没有涉及到商品库存)，目前用户量还没有上来，目前没有出现问题，但是想到如果用户量变大，下单并发量变大，可能会出现一系列的问题，趁着空闲时间，做了这个demo测试相关问题。</p><p>可能遇到的问题如下：</p><ol><li>订单重复</li><li>高并发下，性能变慢</li></ol><p>解决方式：<code>ThreadPoolExecutor</code>线程池 + Queue队列</p><h2 id="_1-首先是springboot的项目框架如下" tabindex="-1"><a class="header-anchor" href="#_1-首先是springboot的项目框架如下" aria-hidden="true">#</a> 1.首先是springBoot的项目框架如下：</h2><figure><img src="http://122.9.159.116:5244/d/ecloud180/images/blogImage/image-20220524225159288.png" alt="image-20220524225159288" tabindex="0" loading="lazy"><figcaption>image-20220524225159288</figcaption></figure><h2 id="_2-业务测试流程涉及的类-如下" tabindex="-1"><a class="header-anchor" href="#_2-业务测试流程涉及的类-如下" aria-hidden="true">#</a> 2.业务测试流程涉及的类，如下</h2><ul><li>BusinessThread 类</li></ul><div class="language-text line-numbers-mode" data-ext="text"><pre class="language-text"><code>package com.springboot.demo.Threads;
