import{_ as n}from"./plugin-vue_export-helper-c27b6911.js";import{o as s,c as a,a as e}from"./app-a8514216.js";const i={},l=e(`<h1 id="nfs在线安装和离线安装" tabindex="-1"><a class="header-anchor" href="#nfs在线安装和离线安装" aria-hidden="true">#</a> NFS在线安装和离线安装</h1><h2 id="_1-在线安装" tabindex="-1"><a class="header-anchor" href="#_1-在线安装" aria-hidden="true">#</a> 1. 在线安装：</h2><h4 id="第一步-在文件主服务器上安装-nfs-kernel-server" tabindex="-1"><a class="header-anchor" href="#第一步-在文件主服务器上安装-nfs-kernel-server" aria-hidden="true">#</a> 第一步：在文件主服务器上安装 <code>nfs-kernel-server</code></h4><div class="language-bash line-numbers-mode" data-ext="sh"><pre class="language-bash"><code><span class="token comment"># rpcbind nfs-kernel-server nfs-common net-tools</span>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h4 id="第二步-在文件共享节点上安装-nfs-common" tabindex="-1"><a class="header-anchor" href="#第二步-在文件共享节点上安装-nfs-common" aria-hidden="true">#</a> 第二步：在文件共享节点上安装 <code>nfs-common</code></h4><div class="language-bash line-numbers-mode" data-ext="sh"><pre class="language-bash"><code><span class="token comment"># 1. 安装 rpcbind， nfs 依赖 rpc 进行相互通信</span>
<span class="token function">apt-get</span> <span class="token function">install</span> <span class="token parameter variable">-y</span> rpcbind
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h4 id="第三步-基本验证" tabindex="-1"><a class="header-anchor" href="#第三步-基本验证" aria-hidden="true">#</a> 第三步：基本验证</h4><div class="language-bash line-numbers-mode" data-ext="sh"><pre class="language-bash"><code><span class="token comment"># 基本的增删文件校验，此处省略</span>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h3 id="_2-内网环境下离线安装" tabindex="-1"><a class="header-anchor" href="#_2-内网环境下离线安装" aria-hidden="true">#</a> 2. 内网环境下离线安装</h3><h4 id="第一步-在外网环境下打包安装包和依赖" tabindex="-1"><a class="header-anchor" href="#第一步-在外网环境下打包安装包和依赖" aria-hidden="true">#</a> 第一步：在外网环境下打包安装包和依赖</h4><h5 id="nfs-kernel-server-服务" tabindex="-1"><a class="header-anchor" href="#nfs-kernel-server-服务" aria-hidden="true">#</a> <code>nfs-kernel-server</code> 服务：</h5><div class="language-bash line-numbers-mode" data-ext="sh"><pre class="language-bash"><code><span class="token comment"># rpcbind nfs-kernel-server nfs-common net-tools</span>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p><code>nfs-common</code> 服务：</p><p>离线打包步骤和 <code>nfs-kernel-server </code>相同，把上面的 <code>nfs-kernel-server</code> 替换为 <code>nfs-common</code> 直接执行</p><h2 id="nfs-漏洞-showmount-e-信息泄露" tabindex="-1"><a class="header-anchor" href="#nfs-漏洞-showmount-e-信息泄露" aria-hidden="true">#</a> NFS 漏洞：showmount -e 信息泄露</h2><blockquote><p>实现允许指定主机通过 mount 到 nfs 服务器上，阻止其它主机通过 shutdown -e 方式，泄露 NFS 共享目录结构信息。</p></blockquote><h4 id="_1-编辑-etc-hosts-allow" tabindex="-1"><a class="header-anchor" href="#_1-编辑-etc-hosts-allow" aria-hidden="true">#</a> 1. 编辑 /etc/hosts.allow</h4><div class="language-bash line-numbers-mode" data-ext="sh"><pre class="language-bash"><code><span class="token function">sudo</span> <span class="token function">vi</span> /etc/hosts.allow
<span class="token comment"># 附加允许访问的 mount 和 rpc 地址</span>
mountd:192.168.1.3,192.168.1.4
rpcbind:192.168.1.3,192.168.1.4:allow
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h4 id="_2-编辑-etc-hosts-deny" tabindex="-1"><a class="header-anchor" href="#_2-编辑-etc-hosts-deny" aria-hidden="true">#</a> 2. 编辑 /etc/hosts.deny</h4><div class="language-bash line-numbers-mode" data-ext="sh"><pre class="language-bash"><code><span class="token function">sudo</span> <span class="token function">vi</span> /etc/hosts.deny
<span class="token comment"># 添加拒绝mount和 rpc的访问</span>
mountd:all
rpcbind:ALL:deny
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h4 id="_3-验证访问控制是否生效" tabindex="-1"><a class="header-anchor" href="#_3-验证访问控制是否生效" aria-hidden="true">#</a> 3. 验证访问控制是否生效</h4><div class="language-bash line-numbers-mode" data-ext="sh"><pre class="language-bash"><code><span class="token comment"># 上述配置无需重启即可生效</span>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h2 id="开机自动挂载" tabindex="-1"><a class="header-anchor" href="#开机自动挂载" aria-hidden="true">#</a> 开机自动挂载</h2><p>如果按本文上面的部分配置好，NFS即部署好了，但是如果你重启客户端系统，发现不能随机器一起挂载，需要再次手动操作挂载，这样操作比较麻烦，因此我们需要设置开机自动挂载。我们不要把挂载项写到/etc/fstab文件中，因为开机时先挂载本机磁盘再启动网络，而NFS是需要网络启动后才能挂载的，所以我们把挂载命令写入到/etc/rc.d/rc.local文件中即可。</p><div class="language-bash line-numbers-mode" data-ext="sh"><pre class="language-bash"><code><span class="token function">vim</span> /etc/rc.d/rc.local
在文件最后添加一行：
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h2 id="问题" tabindex="-1"><a class="header-anchor" href="#问题" aria-hidden="true">#</a> 问题</h2><p>没有同步，可能<code>rpcbind</code> 出问题，重启</p><div class="language-bash line-numbers-mode" data-ext="sh"><pre class="language-bash"><code><span class="token comment"># 重启，避免不会同步</span>
/etc/init.d/rpcbind restart
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div></div></div>`,29),c=[l];function o(t,r){return s(),a("div",null,c)}const m=n(i,[["render",o],["__file","NFS在线安装和离线安装.html.vue"]]);export{m as default};
