...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h4 id="_2-3-2-3-快速排序非递归" tabindex="-1"><a class="header-anchor" href="#_2-3-2-3-快速排序非递归" aria-hidden="true">#</a> 2.3.2.3 快速排序非递归</h4><p>两种思路进行实现：</p><h5 id="_2-3-2-3-1-栈模拟递归实现" tabindex="-1"><a class="header-anchor" href="#_2-3-2-3-1-栈模拟递归实现" aria-hidden="true">#</a> 2.3.2.3.1 栈模拟递归实现</h5><p>思路：</p><p><strong>将需要使用到的下标放到栈上临时存储（为什么只存下标？因为PartSort()函数只需要用到函数名和下标），然后使用栈的性质，每当拿出一对下标时，将得到的新下标依次压入栈中，这样，始终都是先对右边的下标进行排序，模拟了递归的性质。</strong></p><p><img src="http://122.9.159.116:5244/d/ecloud180/images/blogImage/079858f522d812594312eab72b433dcb.png" alt="image-20220422195516422"></p><p>代码实现：</p><div class="language-C line-numbers-mode" data-ext="C"><pre class="language-C"><code>//快速排序的非递归形式1：通过栈来实现
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>上面的代码经过打印，在测试非2的幂次方个数目的数组时程序就会出现问题，例如当我们测试10个数时看一下打印的下标：</p><p><img src="http://122.9.159.116:5244/d/ecloud180/images/blogImage/2f5e6483ad4313ba5adaedf519b4a551.png" alt="image-20220423185520974"></p><p>发生了越界（总共有10个数字，下标最大为9，所以程序出现了问题）</p><p>下面将进行一次修正，将越界的下标数字强制修改为n-1，修正部分的代码如下所示：</p><div class="language-C line-numbers-mode" data-ext="C"><pre class="language-C"><code>if (end1 &gt;= n)
{
	end1 = n - 1;
}
if (begin2 &gt;= n)
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h4 id="_2-4-4-归并排序的特性总结" tabindex="-1"><a class="header-anchor" href="#_2-4-4-归并排序的特性总结" aria-hidden="true">#</a> 2.4.4 归并排序的特性总结</h4><ol><li>归并的缺点在于需要O(N)的空间复杂度，归并排序的思考更多的是解决在磁盘中的外排序问题。</li><li>时间复杂度：O(N*logN) 如何理解归并排序的时间复杂度？ <img src="http://122.9.159.116:5244/d/ecloud180/images/blogImage/57c171c5539166024671fba819d5533b.png" alt="image-20220423205120424"></li><li>空间复杂度：O(N) 注意：实际上应该是O(N + log2N)（N是开辟的数组的空间，log2N是开辟栈帧的层数（递归版本，非递归就没有），log2N太小，可以看成是常数，几乎忽略不计，所以就是O(N)）</li><li>稳定性：稳定</li></ol><h3 id="_2-5-七大排序性能测试比较" tabindex="-1"><a class="header-anchor" href="#_2-5-七大排序性能测试比较" aria-hidden="true">#</a> 2.5 七大排序性能测试比较</h3><h4 id="_2-5-1-测试比较代码" tabindex="-1"><a class="header-anchor" href="#_2-5-1-测试比较代码" aria-hidden="true">#</a> 2.5.1 测试比较代码</h4><p>代码：</p><div class="language-C line-numbers-mode" data-ext="C"><pre class="language-C"><code>// 测试排序的性能对比
void TestOP()
{
