...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div></div></div><h4 id="_3-3-环境设置" tabindex="-1"><a class="header-anchor" href="#_3-3-环境设置" aria-hidden="true">#</a> 3.3. 环境设置</h4><p>此时 <code>sqlplus</code> 是不可以用的，需要配置一下环境变量。</p><figure><img src="https://static.xlc520.ml/blogImage/9a34b3e6187fe82094f7098c412e6d04.png" alt="20220726163736" tabindex="0" loading="lazy"><figcaption>20220726163736</figcaption></figure><p>切换回到容器中的 <code>root</code> 用户，密码为 <code>helowin</code> 。</p><h4 id="_3-3-1-编辑环境变量" tabindex="-1"><a class="header-anchor" href="#_3-3-1-编辑环境变量" aria-hidden="true">#</a> 3.3.1. 编辑环境变量</h4><p>优化冒泡排序和选择排序zip <img src="https://static.xlc520.ml/blogImage/star.png" alt="img" loading="lazy"></p><p>0星超过10%的资源595KB</p><figure><img src="https://static.xlc520.ml/blogImage/arrowDownWhite.png" alt="img" tabindex="0" loading="lazy"><figcaption>img</figcaption></figure><div class="language-bash line-numbers-mode" data-ext="sh"><pre class="language-bash"><code><span class="token function">vi</span> /etc/profile
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div></div></div><p>冒泡排序和选择法排序的源代码 <img src="https://static.xlc520.ml/blogImage/star.png" alt="img" loading="lazy"></p><figure><img src="https://static.xlc520.ml/blogImage/arrowDownWhite.png" alt="img" tabindex="0" loading="lazy"><figcaption>img</figcaption></figure><h4 id="_3-5-2-添加和授权用户" tabindex="-1"><a class="header-anchor" href="#_3-5-2-添加和授权用户" aria-hidden="true">#</a> 3.5.2. 添加和授权用户</h4><div class="language-sql line-numbers-mode" data-ext="sql"><pre class="language-sql"><code><span class="token keyword">create</span> <span class="token keyword">user</span> test identified <span class="token keyword">by</span> test<span class="token punctuation">;</span> <span class="token comment">-- 创建内部管理员账号密码；</span>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div></div></div><figure><img src="https://static.xlc520.ml/blogImage/2031bd4759e54c4c9dd4249ab2e29eee.png" alt="在这里插入图片描述" tabindex="0" loading="lazy"><figcaption>在这里插入图片描述</figcaption></figure><h3 id="第二步-创建挂载文件" tabindex="-1"><a class="header-anchor" href="#第二步-创建挂载文件" aria-hidden="true">#</a> 第二步：创建挂载文件</h3><div class="language-bash line-numbers-mode" data-ext="sh"><pre class="language-bash"><code><span class="token comment"># 创建文件</span>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div></div></div><p>如果你在安装的时候没有设置密码的话</p><p>oracle有三个默认的用户名和密码</p><p>1.用户名:sys密码:change_on_install</p><p>2.用户名:system密码:manager</p><p>3.用户名:scott密码:tiger</p>`,24);function m(v,b){const e=r("ExternalLinkIcon");return l(),c("div",null,[o,a("p",null,[n("还可以通过访问"),a("a",p,[n("https://localhost:5502/em"),t(e)])]),u])}const g=i(d,[["render",m],["__file","Docker安装Oracle.html.vue"]]);export{g as default};
