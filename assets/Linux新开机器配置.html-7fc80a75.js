import{_ as i}from"./plugin-vue_export-helper-c27b6911.js";import{r as c,o as r,c as o,b as n,d as e,e as a,a as t}from"./app-e061b827.js";const l={},u=t(`<h1 id="linux新开机器配置" tabindex="-1"><a class="header-anchor" href="#linux新开机器配置" aria-hidden="true">#</a> Linux新开机器配置</h1><h2 id="_1-更换yum-apt源" tabindex="-1"><a class="header-anchor" href="#_1-更换yum-apt源" aria-hidden="true">#</a> 1.更换yum/apt源</h2><blockquote><p><strong>通知：CentOS 8操作系统版本结束了生命周期（EOL），Linux社区已不再维护该操作系统版本。建议您切换到Anolis或Alinux。如果您的业务过渡期仍需要使用CentOS 8系统中的一些安装包，请根据下文切换CentOS 8的源。</strong></p></blockquote><h3 id="centos" tabindex="-1"><a class="header-anchor" href="#centos" aria-hidden="true">#</a> CentOS</h3><h4 id="_1-备份" tabindex="-1"><a class="header-anchor" href="#_1-备份" aria-hidden="true">#</a> 1. 备份</h4><div class="language-text line-numbers-mode" data-ext="text"><pre class="language-text"><code>mv /etc/yum.repos.d/CentOS-Base.repo /etc/yum.repos.d/CentOS-Base.repo.backup
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div></div></div>`,11);function g(y,x){const s=c("ExternalLinkIcon");return r(),o("div",null,[u,n("p",null,[e("2、修改"),d,e("文件，将"),n("strong",null,[n("a",m,[e("http://archive.ubuntu.com"),a(s)])]),e("和"),n("strong",null,[n("a",p,[e("http://security.ubuntu.com"),a(s)])]),e("替换成"),n("strong",null,[n("a",v,[e("http://repo.huaweicloud.com"),a(s)])]),e("，可以参考如下命令：")]),n("p",null,[e('sudo sed -i "s@'),n("a",b,[e("http://.*archive.ubuntu.com@http"),a(s)]),e('😕/repo.huaweicloud.com@g" /etc/apt/sources.list'),h,e(' sudo sed -i "s@'),n("a",k,[e("http://.*security.ubuntu.com@http"),a(s)]),e('😕/repo.huaweicloud.com@g" /etc/apt/sources.list')]),f])}const S=i(l,[["render",g],["__file","Linux新开机器配置.html.vue"]]);export{S as default};
