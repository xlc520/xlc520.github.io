...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div></div></div><p>冒泡排序和选择法排序的源代码 <img src="https://static.xlc520.tk/blogImage/star.png" alt="img" loading="lazy"></p><figure><img src="https://static.xlc520.tk/blogImage/arrowDownWhite.png" alt="img" tabindex="0" loading="lazy"><figcaption>img</figcaption></figure><h4 id="_3-5-2-添加和授权用户" tabindex="-1"><a class="header-anchor" href="#_3-5-2-添加和授权用户" aria-hidden="true">#</a> 3.5.2. 添加和授权用户</h4><div class="language-sql line-numbers-mode" data-ext="sql"><pre class="language-sql"><code><span class="token keyword">create</span> <span class="token keyword">user</span> test identified <span class="token keyword">by</span> test<span class="token punctuation">;</span> <span class="token comment">-- 创建内部管理员账号密码；</span>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div></div></div><p>如果你在安装的时候没有设置密码的话</p><p>oracle有三个默认的用户名和密码</p><p>1.用户名:sys密码:change_on_install</p><p>2.用户名:system密码:manager</p><p>3.用户名:scott密码:tiger</p>`,127),c=[l];function t(r,d){return n(),s("div",null,c)}const u=a(i,[["render",t],["__file","Docker安装Oracle.html.vue"]]);export{u as default};
