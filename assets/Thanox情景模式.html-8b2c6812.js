...
<span class="token punctuation">]</span>
  ...
  <span class="token punctuation">}</span>
<span class="token punctuation">]</span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div>`,35);function k(v,m){const t=p("ExternalLinkIcon");return o(),i("div",null,[l,s("p",null,[n("1需要下载su插件 地址（新版thanox的插件仓库中已预存插件 直接安装即可）"),s("a",r,[n("查看链接"),u(t)]),n(" 设置插件允许 root。")]),d])}const b=e(c,[["render",k],["__file","Thanox情景模式.html.vue"]]);export{b as default};
