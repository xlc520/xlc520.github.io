...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h3 id="_7-添加-ik-分词器" tabindex="-1"><a class="header-anchor" href="#_7-添加-ik-分词器"><span>7）添加 IK 分词器</span></a></h3><p>GitHub 下载地址：https://github.com/medcl/elasticsearch-analysis-ik/releases</p><div class="language-bash line-numbers-mode" data-ext="sh" data-title="sh"><pre class="language-bash"><code><span class="token comment"># 将下载的分词器复制到ES安装目录的plugins目录中并进行解压</span>
