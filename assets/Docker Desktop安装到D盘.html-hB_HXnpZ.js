import{_ as n}from"./plugin-vue_export-helper-x3n3nnut.js";import{o as e,c as i,a as l}from"./app-V68d0221.js";const s={},o=l(`<h1 id="docker-desktop安装到d盘" tabindex="-1"><a class="header-anchor" href="#docker-desktop安装到d盘" aria-hidden="true">#</a> Docker Desktop安装到D盘</h1><h2 id="安装" tabindex="-1"><a class="header-anchor" href="#安装" aria-hidden="true">#</a> 安装</h2><ul><li>docker官网下载docker desktop installer.exe安装程序。</li><li>进入下载目录，使用cmd直接执行以下命令(powershell官方给出的不知道为啥报错)。</li></ul><div class="language-text line-numbers-mode" data-ext="text"><pre class="language-text"><code>start /w &quot;&quot; &quot;Docker Desktop Installer.exe&quot; install --installation-dir=D:\\Docker
