...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h3 id="\u300C\u4F7F\u7528-podman\u300D" tabindex="-1"><a class="header-anchor" href="#\u300C\u4F7F\u7528-podman\u300D" aria-hidden="true">#</a> <strong>\u300C\u4F7F\u7528 Podman\u300D</strong></h3><p>\u4F7F\u7528 Podman \u975E\u5E38\u7684\u7B80\u5355\uFF0CPodman \u7684\u6307\u4EE4\u8DDF Docker \u5927\u591A\u6570\u90FD\u662F\u76F8\u540C\u7684\u3002\u4E0B\u9762\u6211\u4EEC\u6765\u770B\u51E0\u4E2A\u5E38\u7528\u7684\u4F8B\u5B50\uFF1A</p><h4 id="\u8FD0\u884C\u4E00\u4E2A\u5BB9\u5668" tabindex="-1"><a class="header-anchor" href="#\u8FD0\u884C\u4E00\u4E2A\u5BB9\u5668" aria-hidden="true">#</a> \u8FD0\u884C\u4E00\u4E2A\u5BB9\u5668</h4><div class="language-text ext-text line-numbers-mode"><pre class="language-text"><code>[root@localhost ~]# podman run -d --name httpd docker.io/library/httpd
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>\u6CE8\u610F\uFF1A-l \u662F\u6700\u65B0\u5BB9\u5668\u7684\u4FBF\u5229\u53C2\u6570\u3002\u60A8\u8FD8\u53EF\u4EE5\u4F7F\u7528\u5BB9\u5668\u7684 ID \u4EE3\u66FF -l\u3002</p><h4 id="\u67E5\u770B\u4E00\u4E2A\u8FD0\u884C\u4E2D\u5BB9\u5668\u7684\u65E5\u5FD7" tabindex="-1"><a class="header-anchor" href="#\u67E5\u770B\u4E00\u4E2A\u8FD0\u884C\u4E2D\u5BB9\u5668\u7684\u65E5\u5FD7" aria-hidden="true">#</a> \u67E5\u770B\u4E00\u4E2A\u8FD0\u884C\u4E2D\u5BB9\u5668\u7684\u65E5\u5FD7</h4><div class="language-text ext-text line-numbers-mode"><pre class="language-text"><code>\u9009\u9879
  --latest    #\u6700\u8FD1\u7684
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>\u67E5\u770B\u4E00\u4E2A\u8FD0\u884C\u5BB9\u5668\u4E2D\u7684\u8FDB\u7A0B\u8D44\u6E90\u4F7F\u7528\u60C5\u51B5\uFF0C\u53EF\u4EE5\u4F7F\u7528top\u89C2\u5BDF\u5BB9\u5668\u4E2D\u7684 nginx pid</p><div class="language-text ext-text line-numbers-mode"><pre class="language-text"><code>\u8BED\u6CD5\uFF1A
...
CONTAINER ID  IMAGE  COMMAND  CREATED  STATUS  PORTS  NAMES
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>\u4EE5\u4E0A\u8FD9\u4E9B\u7279\u6027\u57FA\u672C\u4E0A\u90FD\u548C Docker \u4E00\u6837\uFF0CPodman \u9664\u4E86\u517C\u5BB9\u8FD9\u4E9B\u7279\u6027\u5916\uFF0C\u8FD8\u652F\u6301\u4E86\u4E00\u4E9B\u65B0\u7684\u7279\u6027\u3002</p><h4 id="\u4E0A\u4F20\u955C\u50CF" tabindex="-1"><a class="header-anchor" href="#\u4E0A\u4F20\u955C\u50CF" aria-hidden="true">#</a> \u4E0A\u4F20\u955C\u50CF</h4>`,39),S=n("\u4F8B\u5982\uFF0C\u5982\u679C\u6211\u4EEC\u60F3\u5728 "),N={href:"http://docker.io",target:"_blank",rel:"noopener noreferrer"},w=n("docker.io"),O=n(" \u4E0A\u5206\u4EAB\u6211\u4EEC\u65B0\u5EFA\u7684 Nginx \u5BB9\u5668\u955C\u50CF\uFF0C\u8FD9\u5F88\u5BB9\u6613\u3002\u9996\u5148\u767B\u5F55\u7801\u5934\uFF1A"),R=s(`<div class="language-text ext-text line-numbers-mode"><pre class="language-text"><code>[root@localhost nginx]# tree 
.
\u251C\u2500\u2500 Dockerfile
\u2514\u2500\u2500 files
    \u2514\u2500\u2500 nginx-1.20.1.tar.gz
...
alias docker=&#39;podman&#39;
.......
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h3 id="\u300C\u7528\u6237\u64CD\u4F5C\u300D" tabindex="-1"><a class="header-anchor" href="#\u300C\u7528\u6237\u64CD\u4F5C\u300D" aria-hidden="true">#</a> <strong>\u300C\u7528\u6237\u64CD\u4F5C\u300D</strong></h3><p>\u5728\u5141\u8BB8\u6CA1\u6709root\u7279\u6743\u7684\u7528\u6237\u8FD0\u884CPodman\u4E4B\u524D\uFF0C\u7BA1\u7406\u5458\u5FC5\u987B\u5B89\u88C5\u6216\u6784\u5EFAPodman\u5E76\u5B8C\u6210\u4EE5\u4E0B\u914D\u7F6E</p><p>cgroup V2Linux\u5185\u6838\u529F\u80FD\u5141\u8BB8\u7528\u6237\u9650\u5236\u666E\u901A\u7528\u6237\u5BB9\u5668\u53EF\u4EE5\u4F7F\u7528\u7684\u8D44\u6E90\uFF0C\u5982\u679C\u4F7F\u7528cgroupV2\u542F\u7528\u4E86\u8FD0\u884CPodman\u7684Linux\u53D1\u884C\u7248\uFF0C\u5219\u53EF\u80FD\u9700\u8981\u66F4\u6539\u9ED8\u8BA4\u7684OCI\u8FD0\u884C\u65F6\u3002\u67D0\u4E9B\u8F83\u65E7\u7684\u7248\u672Crunc\u4E0D\u9002\u7528\u4E8EcgroupV2\uFF0C\u5FC5\u987B\u5207\u6362\u5230\u5907\u7528OCI\u8FD0\u884C\u65F6crun\u3002</p><div class="language-text ext-text line-numbers-mode"><pre class="language-text"><code>[root@localhost ~]# yum -y install crun     //centos8\u7CFB\u7EDF\u81EA\u5E26
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>\u5982\u679C\u5B83\u4EEC\u4EE5\u8BE5\u987A\u5E8F\u5B58\u5728\u3002\u6BCF\u4E2A\u6587\u4EF6\u90FD\u53EF\u4EE5\u8986\u76D6\u7279\u5B9A\u5B57\u6BB5\u7684\u524D\u4E00\u4E2A\u6587\u4EF6\u3002</p><p>\u914D\u7F6Estorage.conf\u6587\u4EF6</p><div class="language-text ext-text line-numbers-mode"><pre class="language-text"><code>1./etc/containers/storage.conf
2.$HOME/.config/containers/storage.conf
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div></div></div><p>\u5728\u666E\u901A\u7528\u6237\u4E2D**/etc/containers/storage.conf**\u7684\u4E00\u4E9B\u5B57\u6BB5\u5C06\u88AB\u5FFD\u7565</p><div class="language-text ext-text line-numbers-mode"><pre class="language-text"><code>[root@localhost ~]#  vi /etc/containers/storage.conf
[storage]
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>\u5728\u666E\u901A\u7528\u6237\u4E2D\u8FD9\u4E9B\u5B57\u6BB5\u9ED8\u8BA4</p><div class="language-text ext-text line-numbers-mode"><pre class="language-text"><code>graphroot=&quot;$HOME/.local/share/containers/storage&quot;
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>\u6388\u6743\u6587\u4EF6</p><p>\u6B64\u6587\u4EF6\u91CC\u9762\u5199\u4E86docker\u8D26\u53F7\u7684\u5BC6\u7801\uFF0C\u4EE5\u52A0\u5BC6\u65B9\u5F0F\u663E\u793A</p><div class="language-text ext-text line-numbers-mode"><pre class="language-text"><code>[root@localhost ~]# podman login
Username: 1314444
Password: 
Login Succeeded!
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>\u666E\u901A\u7528\u6237\u662F\u65E0\u6CD5\u770B\u89C1root\u7528\u6237\u7684\u955C\u50CF\u7684</p><div class="language-text ext-text line-numbers-mode"><pre class="language-text"><code>//root\u7528\u6237
[root@localhost ~]# podman images
REPOSITORY                  TAG      IMAGE ID       CREATED       SIZE
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>\u4F7F\u7528\u666E\u901A\u7528\u6237\u6620\u5C04\u5BB9\u5668\u7AEF\u53E3\u65F6\u4F1A\u62A5\u201C permission denied\u201D\u7684\u9519\u8BEF</p><div class="language-text ext-text line-numbers-mode"><pre class="language-text"><code>[zz@localhost ~]$ podman run  -d -p 80:80 httpd
Error: rootlessport cannot expose privileged port 80, you can add &#39;net.ipv4.ip_unprivileged_port_start=80&#39; to /etc/sysctl.conf (currently 1024), or choose a larger port number (&gt;= 1024): listen tcp 0.0.0.0:80: bind: permission denied
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div></div></div><p>\u666E\u901A\u7528\u6237\u53EF\u4EE5\u6620\u5C04&gt;= 1024\u7684\u7AEF\u53E3</p><div class="language-text ext-text line-numbers-mode"><pre class="language-text"><code>[zz@localhost ~]$ podman run  -d -p 1024:80 httpd
...
LISTEN      0           128                          *:1024                      *:*                      
LISTEN      0           128                       [::]:22                     [::]:* 
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>\u914D\u7F6Eecho \u2018net.ipv4.ip_unprivileged_port_start=80\u2019 &gt;&gt; /etc/sysctl.conf\u540E\u53EF\u4EE5\u6620\u5C04\u5927\u4E8E\u7B49\u4E8E80\u7684\u7AEF\u53E3</p><div class="language-text ext-text line-numbers-mode"><pre class="language-text"><code>[root@localhost ~]# echo  &#39;net.ipv4.ip_unprivileged_port_start=80&#39;  &gt;&gt; /etc/sysctl.conf
...
LISTEN      0           128                          *:80                        *:*                      
LISTEN      0           128                       [::]:22                     [::]:*  
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div>`,52);function M(G,U){const i=l("ExternalLinkIcon");return r(),o("div",null,[c,e("p",null,[v,e("a",u,[m,d(i)])]),b,p,h,e("p",null,[g,e("a",x,[f,d(i)])]),_,e("ul",null,[q,k,y,D,E,e("li",null,[I,e("a",z,[P,d(i)]),A]),T]),C,e("p",null,[S,e("a",N,[w,d(i)]),O]),R])}var V=a(t,[["render",M],["__file","Podman\u5F00\u6E90\u7684\u5BB9\u5668.html.vue"]]);export{V as default};
