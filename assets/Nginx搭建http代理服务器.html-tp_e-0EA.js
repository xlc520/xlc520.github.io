import{_ as n}from"./plugin-vue_export-helper-x3n3nnut.js";import{o as a,c as s,a as e}from"./app-V68d0221.js";const t={},l=e(`<h1 id="nginx搭建http代理服务器" tabindex="-1"><a class="header-anchor" href="#nginx搭建http代理服务器" aria-hidden="true">#</a> Nginx搭建http代理服务器</h1><p>参考 ： https://blog.csdn.net/weixin_43834401/article/details/130670792</p><p>Nginx服务器作为正向代理服务器和反向代理服务器，<code>但美中不足的是仅支持http协议，不支持https协议</code>。</p><p>http和https的区别：</p><ul><li><strong>http协议</strong>：协议以明文方式发送数据，不提供任何方式的数据加密。不适合传输一些敏感信息，例如密码。其使用的端口是<code>80</code>。</li><li><strong>https协议</strong>：在http协议的基础上，加入了<code>SSL（Secure Sockets Layer）</code>，用于对数据进行加密。其使用的端口为<code>443</code>。</li></ul><h2 id="_1-nginx正向代理-http" tabindex="-1"><a class="header-anchor" href="#_1-nginx正向代理-http" aria-hidden="true">#</a> <strong>1.Nginx正向代理（http）</strong></h2><p>我们来回顾一下Nginx作为正向代理服务器支持http协议的配置。</p><p>代理服务器：192.168.110.101</p><p>代理服务器配置：</p><div class="language-properties line-numbers-mode" data-ext="properties"><pre class="language-properties"><code><span class="token key attr-name">server</span> <span class="token value attr-value">{</span>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>客户端配置：</p><blockquote><p>我们使用Windows系统作为客户端环境。</p></blockquote><p>访问<code>http://nginx.org/en/index.html</code>，可以正常访问。</p><p>访问<code>https://www.baidu.com</code>，则无法正常访问了。</p><p>查看代理服务器的<code>error.log</code>，发现其报400错误码。</p><p>这是因为，Nginx作为正向代理服务器时，默认仅支持http协议，是不支持https协议的。</p><h2 id="_2-nginx正向代理-https" tabindex="-1"><a class="header-anchor" href="#_2-nginx正向代理-https" aria-hidden="true">#</a> <strong>2.Nginx正向代理（https）</strong></h2><p><strong>那么怎么让Nginx作为正向代理服务器的时候支持https协议呢？</strong></p><p>我们可以使用第三方模块<code>ngx_http_proxy_connect_module</code>。</p><p>下载地址：https://github.com/chobits/ngx_http_proxy_connect_module</p><p>我们知道如果要为Nginx添加第三方模块，需要在配置<code>configure</code>时添加<code>--add-module</code>。从Nginx1.9.11版本开始，支持<code>load_module</code>指令来动态加载模块。</p><p>我们这里使用<code>--add-module</code>进行模块的添加。</p><p><strong>1）查看Nginx版本以及configure信息</strong></p><div class="language-bash line-numbers-mode" data-ext="sh"><pre class="language-bash"><code>nginx <span class="token parameter variable">-V</span>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p><strong>2）下载模块</strong></p><p>下载地址：https://codeload.github.com/chobits/ngx_http_proxy_connect_module/zip/refs/heads/master</p><p><strong>3）重新编译</strong></p><p>这里我们两种添加第三方模块的方式都尝试一下。</p><p>使用<code>--add-module</code></p><div class="language-bash line-numbers-mode" data-ext="sh"><pre class="language-bash"><code><span class="token builtin class-name">cd</span> /home/stone/nginx-1.22.1
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>使用<code>load_module</code>，需要将<code>--add-module</code>替换为<code>--add-dynamic-module</code></p><div class="language-bash line-numbers-mode" data-ext="sh"><pre class="language-bash"><code><span class="token builtin class-name">cd</span> /home/stone/nginx-1.22.1
...
<span class="token function">make</span> upgrade
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p><strong>4）修改配置文件</strong></p><div class="language-properties line-numbers-mode" data-ext="properties"><pre class="language-properties"><code><span class="token comment"># --add-dynamic-module动态添加第三方模块时使用</span>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>此时访问<code>https://www.baidu.com</code>，在<code>access_proxy.log</code>产生如下日志，说明https代理成功。</p><h2 id="_3-nginx反向代理-http" tabindex="-1"><a class="header-anchor" href="#_3-nginx反向代理-http" aria-hidden="true">#</a> <strong>3.Nginx反向代理（http）</strong></h2><p>同样的，Nginx作为反向代理服务器，默认也是只支持http协议，我们来回顾一下Nginx作为反向代理服务器支持http协议的配置。</p><div class="language-properties line-numbers-mode" data-ext="properties"><pre class="language-properties"><code><span class="token key attr-name">server</span> <span class="token value attr-value">{</span>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>可以看到，我们配置的<code>server_name</code>为<code>localhost</code>，但在实际项目中，我们是使用域名绑定Nginx服务器的IP，并且使用https协议进行访问，配置的<code>server_name</code>就是指定的域名，例如<code>www.aaa.com</code>。</p><p>Nginx为我们提供了<code>ngx_http_ssl_module</code>来支持https协议，并且在提供的默认配置文件里已经给出了示例。</p><h2 id="_4-nginx反向代理-https" tabindex="-1"><a class="header-anchor" href="#_4-nginx反向代理-https" aria-hidden="true">#</a> <strong>4.Nginx反向代理（https）</strong></h2><p>添加<code>ngx_http_ssl_module</code>的步骤和添加<code>ngx_http_proxy_connect_module</code>的步骤一致，只是这是Nginx提供的模块，因此在configure时使用<code>--with-http_ssl_module</code> 即可。</p><p>我们再来看看采用https协议时的配置：</p><div class="language-properties line-numbers-mode" data-ext="properties"><pre class="language-properties"><code><span class="token key attr-name">server</span> <span class="token value attr-value">{</span>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>我们需要去为指定的域名申请ssl证书，然后将证书中的<code>cert.pem</code>和<code>cert.key</code>放到指定文件，并在配置文件中指定。例如我们这里指定的<code>server_name</code>为<code>www.aaa.com</code>，所以我们就需要为<code>www.aaa.com</code>申请ssl证书。</p><p>后续我们访问<code>https://www.aaa.com/proxy</code>就可以被代理到指定服务端了。</p><h2 id="其他-第二种" tabindex="-1"><a class="header-anchor" href="#其他-第二种" aria-hidden="true">#</a> 其他（第二种）</h2><p>如果不想写到 ngnix.conf 中，那么可以在相同的目录下建立另外一个文件夹存放单独的文件，比如新建一个 proxy 的子目录，然后再在里面新建文件 prox.conf ，然后添加如下内容：</p><div class="language-properties line-numbers-mode" data-ext="properties"><pre class="language-properties"><code><span class="token key attr-name">server</span> <span class="token value attr-value">{</span>
<span class="token key attr-name">    resolver</span> <span class="token value attr-value">       8.8.8.8;</span>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>接着在 ngnix.conf 的 http 块中添加：</p><div class="language-text line-numbers-mode" data-ext="text"><pre class="language-text"><code>include proxy/*.conf;
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div></div></div><p>将上面文件的配置包含进来。</p><p>上面使用谷歌 DNS 8.8.8.8，你可能在本地也需要使用这个 DNS，否则可能会出现 502 的错误。不然可以配置 resolver 地址为你 ISP 分配的 DNS 地址。</p><p>配置完后，重启一下 nginx 或 reload 一下即可。</p><p>注意：由于 HTTP 代理和 VPN 不一样，后者加密，而前者不加密，所以 HTTP 代理是不能用来 FQ 的。</p><p>下面是类似配置内容：</p><div class="language-properties line-numbers-mode" data-ext="properties"><pre class="language-properties"><code><span class="token key attr-name">server</span> <span class="token value attr-value">{</span>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h3 id="example2" tabindex="-1"><a class="header-anchor" href="#example2" aria-hidden="true">#</a> Example2</h3><div class="language-properties line-numbers-mode" data-ext="properties"><pre class="language-properties"><code><span class="token key attr-name">server</span> <span class="token value attr-value">{</span>
