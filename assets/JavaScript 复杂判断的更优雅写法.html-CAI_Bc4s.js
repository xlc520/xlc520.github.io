import{_ as n}from"./plugin-vue_export-helper-DlAUqK2U.js";import{o as a,c as i,a as e}from"./app-DWXdHMII.js";const l={};function p(c,s){return a(),i("div",null,s[0]||(s[0]=[e(`<h1 id="javascript-复杂判断的更优雅写法" tabindex="-1"><a class="header-anchor" href="#javascript-复杂判断的更优雅写法"><span>JavaScript 复杂判断的更优雅写法</span></a></h1><p>我们编写 js 代码时经常遇到复杂逻辑判断的情况，通常大家可以用<code>if/else</code>或者<code>switch</code> 来实现多个条件判断，但这样会有个问题，随着逻辑复杂度的增加，代码中的<code>if/else/switch</code>会变得越来越臃肿，越来越看不懂，那么如何更优雅的写判断逻辑，本文带你试一下。</p><h2 id="举个例子" tabindex="-1"><a class="header-anchor" href="#举个例子"><span>举个例子</span></a></h2><p>先看一段代码：</p><div class="language-plain line-numbers-mode" data-highlighter="shiki" data-ext="plain" data-title="plain" style="--shiki-light:#383A42;--shiki-dark:#abb2bf;--shiki-light-bg:#FAFAFA;--shiki-dark-bg:#282c34;"><pre class="shiki shiki-themes one-light one-dark-pro vp-code"><code><span class="line"><span>/**</span></span>
