import{_ as s}from"./plugin-vue_export-helper-c27b6911.js";import{o as n,c as a,a as e}from"./app-4a6db5be.js";const t={},l=e(`<h1 id="ubuntu配置中文" tabindex="-1"><a class="header-anchor" href="#ubuntu配置中文" aria-hidden="true">#</a> Ubuntu配置中文</h1><p>1.查看当前语言</p><div class="language-bash line-numbers-mode" data-ext="sh"><pre class="language-bash"><code><span class="token builtin class-name">echo</span> <span class="token environment constant">$LANG</span>
