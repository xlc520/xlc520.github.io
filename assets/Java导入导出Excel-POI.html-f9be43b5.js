...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p><em><strong>*三、使用java Excel操作Excel文件*</strong></em></p><p>Java Excel是一开放源码项目，通过它Java开发人员可以读取Excel文件的内容、创建新的Excel文件、更新已经存在的Excel文件。jxl 由于其小巧 易用的特点, 逐渐已经取代了 POI-excel的地位, 成为了越来越多的java开发人员生成excel文件的首选。Java Excel的特征：</p><blockquote><p>● 支持Excel 95-2000的所有版本 ● 生成Excel 2000标准格式 ● 支持字体、数字、日期格式化操作 ● 支持对单元格加阴影和加色彩；</p><p>● 修改存在的工作表； ● 支持图像和图表</p><p>● 日志记录可以定制</p><p>● 更小更快更省内存</p></blockquote><p>应该说以上功能已经能够大致满足我们的需要。最关键的是这套API是纯Java的，并不依赖Windows系统，即使运行在Linux下，它同样能够正确 的处理Excel文件。另外需要说明的是，这套API对图形和图表的支持很有限，而且仅仅识别PNG格式。 在线帮助文档http://jexcelapi.sourceforge.net/resources/javadocs/2_6_10/docs/index.html</p><p>在这里我们将通过一些实例，学习掌握读取、新建、更新，其中也包括常见格式的设置:字体、颜色、背景、合并单元格等操作，有这些其实已经基本足够应付大部分问题了。</p><h3 id="_3-1环境配置" tabindex="-1"><a class="header-anchor" href="#_3-1环境配置" aria-hidden="true">#</a> 3.1环境配置</h3><h3 id="_3-1-1下载" tabindex="-1"><a class="header-anchor" href="#_3-1-1下载" aria-hidden="true">#</a> 3.1.1下载</h3><p>下载地址 http://www.andykhan.com/jexcelapi/</p><h3 id="_3-1-2-加入jar包" tabindex="-1"><a class="header-anchor" href="#_3-1-2-加入jar包" aria-hidden="true">#</a> 3.1.2 加入jar包</h3><p>将jxl.jar拷贝到项目的Lib下</p><h3 id="_3-2-使用java-excel-api-导出-excel文件" tabindex="-1"><a class="header-anchor" href="#_3-2-使用java-excel-api-导出-excel文件" aria-hidden="true">#</a> 3.2 使用Java Excel Api 导出 Excel文件</h3><p>下面我们在看如何使用Java Excel实现导出Excel表格？</p><p>代码如下：（实际开发中应封装到业务层组件中，然后在控制层中调用。这里直接写在控制层组件，如Servlet的doGet/doPost方法或Struts框架的execute方法中）</p><div class="language-text line-numbers-mode" data-ext="text"><pre class="language-text"><code>//获得输出流，该输出流的输出介质是客户端浏览器
...
lable.setString(&quot;As179&quot;);
    ...
    wwb.close(); 
    wk.close(); 
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>对于更新已存在的Excel文件实际上就是获取已有工作薄对象（但是只读的），然后将获取的只读的工作薄对象转化为可写入的Excel工作薄对象（WritableWorkbook ），其他部分就是通过可写入WritableSheet 对象和可写入WritableCell 对象进行编辑。</p>`,96),t=[i];function c(o,d){return e(),s("div",null,t)}const r=n(l,[["render",c],["__file","Java导入导出Excel-POI.html.vue"]]);export{r as default};
