import{_ as e}from"./plugin-vue_export-helper-x3n3nnut.js";import{o as n,c as i,a as d}from"./app-aq8PVJpR.js";const l={},s=d(`<h1 id="springboot定时任务动态管理" tabindex="-1"><a class="header-anchor" href="#springboot定时任务动态管理"><span>SpringBoot定时任务动态管理</span></a></h1><h2 id="一、功能说明" tabindex="-1"><a class="header-anchor" href="#一、功能说明"><span><strong>一、功能说明</strong></span></a></h2><p>SpringBoot的定时任务的加强工具，实现对SpringBoot原生的定时任务进行动态管理,完全兼容原生@Scheduled注解,无需对原本的定时任务进行修改</p><h2 id="二、快速使用" tabindex="-1"><a class="header-anchor" href="#二、快速使用"><span><strong>二、快速使用</strong></span></a></h2><p>具体的功能已经封装成SpringBoot-starter即插即用</p><div class="language-text line-numbers-mode" data-ext="text" data-title="text"><pre class="language-text"><code>&lt;dependency&gt;
