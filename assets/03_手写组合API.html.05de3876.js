import{_ as n}from"./_plugin-vue_export-helper.cdc0426e.js";import{o as s,c as a,d as p}from"./app.eb6bd936.js";const t={},e=p(`<h1 id="_3-手写组合api" tabindex="-1"><a class="header-anchor" href="#_3-手写组合api" aria-hidden="true">#</a> 3. 手写组合API</h1><h2 id="_1-shallowreactive-与-reactive" tabindex="-1"><a class="header-anchor" href="#_1-shallowreactive-与-reactive" aria-hidden="true">#</a> 1) shallowReactive 与 reactive</h2><div class="language-javascript line-numbers-mode" data-ext="js"><pre class="language-javascript"><code><span class="token keyword">const</span> reactiveHandler <span class="token operator">=</span> <span class="token punctuation">{</span>
