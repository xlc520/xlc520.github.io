...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>如果上面安装失败，则下载我百度里的，离线安装</p>`,63),p={href:"https://pan.baidu.com/s/1HB9xuO3bssAW7v5HzpXkeQ",target:"_blank",rel:"noopener noreferrer"},g=e("br",null,null,-1),h=d(`<p>再查看 node 节点，就已经正常了</p><figure><img src="https://static.xlc520.tk/blogImage/640-1667642653045-6.png" alt="K8S高可用部署" tabindex="0" loading="lazy"><figcaption>K8S高可用部署</figcaption></figure><h4 id="_9-node-节点加入-k8s-集群" tabindex="-1"><a class="header-anchor" href="#_9-node-节点加入-k8s-集群" aria-hidden="true">#</a> 9）node 节点加入 k8s 集群</h4><p>先安装 kubelet</p><div class="language-text line-numbers-mode" data-ext="text"><pre class="language-text"><code>yum install -y kubelet kubeadm kubectl --disableexcludes=kubernetes
# 设置为开机自启并现在立刻启动服务 --now：立刻启动服务
systemctl enable --now kubelet
systemctl status kubelet
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div></div></div>`,15),f={href:"https://cluster-endpoint:31443",target:"_blank",rel:"noopener noreferrer"},y=e("figure",null,[e("img",{src:"https://static.xlc520.tk/blogImage/640-1667642653046-20.png",alt:"K8S高可用部署",tabindex:"0",loading:"lazy"}),e("figcaption",null,"K8S高可用部署")],-1),_=e("p",null,"输入上面创建的 token 登录",-1),q=e("figure",null,[e("img",{src:"https://static.xlc520.tk/blogImage/640-1667642653046-21.png",alt:"K8S高可用部署",tabindex:"0",loading:"lazy"}),e("figcaption",null,"K8S高可用部署")],-1),S=e("h3",{id:"四、k8s-镜像仓库-harbor-环境部署",tabindex:"-1"},[e("a",{class:"header-anchor",href:"#四、k8s-镜像仓库-harbor-环境部署","aria-hidden":"true"},"#"),n(" 四、k8s 镜像仓库 harbor 环境部署")],-1),w={href:"https://github.com/helm/helm/releases",target:"_blank",rel:"noopener noreferrer"},C=e("br",null,null,-1),K=d(`<h4 id="_1-安装-helm" tabindex="-1"><a class="header-anchor" href="#_1-安装-helm" aria-hidden="true">#</a> 1）安装 helm</h4><div class="language-text line-numbers-mode" data-ext="text"><pre class="language-text"><code>mkdir -p /opt/k8s/helm &amp;&amp; cd /opt/k8s/helm
...
helm install myharbor --namespace harbor harbor/harbor \\
  ...
  --set externalURL=https://myharbor.com \\
  --set harborAdminPassword=Harbor12345
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><figure><img src="https://static.xlc520.tk/blogImage/640-1667642653046-25.png" alt="K8S高可用部署" tabindex="0" loading="lazy"><figcaption>K8S高可用部署</figcaption></figure><p>5、访问 harbor</p>`,29),V={href:"https://myharbor.com",target:"_blank",rel:"noopener noreferrer"},R=e("br",null,null,-1),D=d(`<figure><img src="https://static.xlc520.tk/blogImage/640-1667642653046-26.png" alt="K8S高可用部署" tabindex="0" loading="lazy"><figcaption>K8S高可用部署</figcaption></figure><p>6、harbor 常见操作<br> 【1】创建项目 bigdata</p><figure><img src="https://static.xlc520.tk/blogImage/640-1667642653046-27.png" alt="K8S高可用部署" tabindex="0" loading="lazy"><figcaption>K8S高可用部署</figcaption></figure><p>【2】配置私有仓库<br> 在文件/etc/docker/daemon.json添加如下内容：</p><div class="language-text line-numbers-mode" data-ext="text"><pre class="language-text"><code>&quot;insecure-registries&quot;:[&quot;https://myharbor.com&quot;]
