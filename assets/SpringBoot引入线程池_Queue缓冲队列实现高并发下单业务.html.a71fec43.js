import{_ as d}from"./_plugin-vue_export-helper.cdc0426e.js";import{o as l,c as r,a as e,b as n,e as a,d as i,r as v}from"./app.eb6bd936.js";const u={},t=i(`<h1 id="springboot-引入线程池-queue缓冲队列实现高并发下单业务" tabindex="-1"><a class="header-anchor" href="#springboot-引入线程池-queue缓冲队列实现高并发下单业务" aria-hidden="true">#</a> SpringBoot 引入线程池+Queue缓冲队列实现高并发下单业务</h1><ul><li>1.首先是springBoot的项目框架如下：</li><li>2.业务测试流程涉及的类，如下</li><li>3.使用JMeter模拟并发下单请求</li><li>4.结果</li></ul><hr><p>主要是自己在项目中(中小型项目) 有支付下单业务(只是办理VIP，没有涉及到商品库存)，目前用户量还没有上来，目前没有出现问题，但是想到如果用户量变大，下单并发量变大，可能会出现一系列的问题，趁着空闲时间，做了这个demo测试相关问题。</p><p>可能遇到的问题如下：</p><ol><li>订单重复</li><li>高并发下，性能变慢</li></ol><p>解决方式：<code>ThreadPoolExecutor</code>线程池 + Queue队列</p><h2 id="_1-首先是springboot的项目框架如下" tabindex="-1"><a class="header-anchor" href="#_1-首先是springboot的项目框架如下" aria-hidden="true">#</a> 1.首先是springBoot的项目框架如下：</h2><p><img src="http://122.9.159.116:5244/d/ecloud180/images/blogImage/image-20220524225159288.png" alt="image-20220524225159288" loading="lazy"></p><h2 id="_2-业务测试流程涉及的类-如下" tabindex="-1"><a class="header-anchor" href="#_2-业务测试流程涉及的类-如下" aria-hidden="true">#</a> 2.业务测试流程涉及的类，如下</h2><ul><li>BusinessThread 类</li></ul><div class="language-text line-numbers-mode" data-ext="text"><pre class="language-text"><code>package com.springboot.demo.Threads;
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div>`,16),c=e("p",null,"基于微服务的思想，构建在 B2C 电商场景下的项目实战。核心技术栈，是 Spring Boot + Dubbo 。未来，会重构成 Spring Cloud Alibaba 。",-1),o={href:"https://github.com/YunaiV/onemall",target:"_blank",rel:"noopener noreferrer"},m=i('<h2 id="_3-使用jmeter模拟并发下单请求" tabindex="-1"><a class="header-anchor" href="#_3-使用jmeter模拟并发下单请求" aria-hidden="true">#</a> 3.使用JMeter模拟并发下单请求</h2><p>[<img src="http://122.9.159.116:5244/d/ecloud180/images/blogImage/640-16533988082341.png" alt="图片" loading="lazy">]</p><h2 id="_4-结果" tabindex="-1"><a class="header-anchor" href="#_4-结果" aria-hidden="true">#</a> 4.结果</h2><p>打印的日志说明，开始的订单直接执行插入到系统，当线程池的容量已经满了，则使用<code>RejectedExecutionHandler</code>方法把后面的订单添加到 Queue缓冲队列，使用<code>ScheduledFuture</code>方法定时(我这里是每秒一次)检查Queue队列，重新把队列里面的订单添加到线程池，执行后面的插入任务。</p><p>部分日志如下</p><p>[<img src="http://122.9.159.116:5244/d/ecloud180/images/blogImage/640-16533988082342.png" alt="图片" loading="lazy">]</p>',6);function b(p,g){const s=v("ExternalLinkIcon");return l(),r("div",null,[t,e("blockquote",null,[c,e("p",null,[n("项目地址："),e("a",o,[n("https://github.com/YunaiV/onemall"),a(s)])])]),m])}const S=d(u,[["render",b],["__file","SpringBoot引入线程池+Queue缓冲队列实现高并发下单业务.html.vue"]]);export{S as default};
