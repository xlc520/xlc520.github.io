import{_ as n}from"./plugin-vue_export-helper-x3n3nnut.js";import{o as e,c as l,a as i}from"./app-AGOZjyqV.js";const s={},o=i(`<h1 id="docker-desktop安装到d盘" tabindex="-1"><a class="header-anchor" href="#docker-desktop安装到d盘"><span>Docker Desktop安装到D盘</span></a></h1><h2 id="安装" tabindex="-1"><a class="header-anchor" href="#安装"><span>安装</span></a></h2><ul><li>docker官网下载docker desktop installer.exe安装程序。</li><li>进入下载目录，使用cmd直接执行以下命令(powershell官方给出的不知道为啥报错)。</li></ul><div class="language-text line-numbers-mode" data-ext="text" data-title="text"><pre class="language-text"><code>start /w &quot;&quot; &quot;Docker Desktop Installer.exe&quot; install --installation-dir=D:\\Docker
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h2 id="设置镜像地址到d盘" tabindex="-1"><a class="header-anchor" href="#设置镜像地址到d盘"><span>设置镜像地址到D盘</span></a></h2><ul><li>如果你想要将 Docker Desktop 的默认虚拟磁盘镜像(Disk image)位置更改至 D 盘，可以按照以下步骤进行操作：</li><li>在系统托盘中找到 Docker Desktop 图标，右键单击并选择“Settings”。</li><li>在左侧导航栏中选择“Resources”选项卡。</li><li>找到“Disk image location”选项，并点击它右侧的“Edit”按钮。</li><li>在打开的对话框中输入 D 盘的路径，例如D:\\Docker\\disk。</li><li>点击 “Apply &amp; Restart” 按钮保存更改并重启 Docker Desktop。</li><li>现在，Docker Desktop 的默认虚拟磁盘镜像位置就被更改为了 D 盘，你可以在此路径下查看和管理 Docker Desktop 的虚拟磁盘镜像了。</li></ul><p>请注意，更改虚拟磁盘镜像位置可能会对已有的容器和镜像造成影响，请在操作前备份好你的数据，以免造成数据丢失。</p>`,7),t=[o];function a(r,d){return e(),l("div",null,t)}const m=n(s,[["render",a],["__file","Docker Desktop安装到D盘.html.vue"]]);export{m as default};
