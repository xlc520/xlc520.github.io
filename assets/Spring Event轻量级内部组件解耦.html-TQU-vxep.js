import{_ as e}from"./plugin-vue_export-helper-x3n3nnut.js";import{o as n,c as i,a as s}from"./app-aq8PVJpR.js";const l={},a=s(`<h1 id="spring-event轻量级内部组件解耦" tabindex="-1"><a class="header-anchor" href="#spring-event轻量级内部组件解耦"><span>Spring Event轻量级内部组件解耦</span></a></h1><h2 id="版本" tabindex="-1"><a class="header-anchor" href="#版本"><span>版本</span></a></h2><ul><li>• JDK 8</li><li>• Spring-boot 2.6.6</li></ul><h2 id="登录事件示例" tabindex="-1"><a class="header-anchor" href="#登录事件示例"><span>登录事件示例</span></a></h2><ul><li>• 下面是一个使用Spring事件处理用户登录的简单示例。在此示例中，我们将创建一个Spring Boot应用程序，演示如何使用Spring事件来处理用户登录事件。</li></ul><h2 id="创建一个登录事件" tabindex="-1"><a class="header-anchor" href="#创建一个登录事件"><span>创建一个登录事件</span></a></h2><ul><li>• 创建一个自定义的事件类，用于表示用户登录事件，例如LogonEvent：</li></ul><div class="language-text line-numbers-mode" data-ext="text" data-title="text"><pre class="language-text"><code>public class LoginEvent extends ApplicationEvent {
