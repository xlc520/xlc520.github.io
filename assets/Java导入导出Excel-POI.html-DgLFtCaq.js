import{_ as i}from"./plugin-vue_export-helper-DlAUqK2U.js";import{r as t,o as c,c as o,d as e,e as n,b as l,a as s}from"./app-Clq2mtAP.js";const p={},d=s('<h1 id="java-导入导出-excel-poi" tabindex="-1"><a class="header-anchor" href="#java-导入导出-excel-poi"><span>Java 导入导出 Excel-POI</span></a></h1><h2 id="一、介绍" tabindex="-1"><a class="header-anchor" href="#一、介绍"><span>一、介绍</span></a></h2><p>当前 B/S 模式已成为应用开发的主流，而在企业办公系统中，常常有客户这样子要求：你要把我们的报表直接用 Excel 打开( 电信系统、银行系统)。或者是：我们已经习惯用 Excel 打印。这样在我们实际的开发中，很多时候需要实现导入、导出 Excel 的应用。</p><p>目前，比较常用的实现 Java 导入、导出 Excel 的技术有两种 Jakarta POI 和 Java Excel</p><p>下面我就分别讲解一下如何使用这两个技术实现导入、导出 Excel</p><h2 id="二、使用-jakarta-poi-导入、导出-excel" tabindex="-1"><a class="header-anchor" href="#二、使用-jakarta-poi-导入、导出-excel"><span>二、使用 Jakarta POI 导入、导出 Excel</span></a></h2>',6),u={href:"http://poi.apache.org/apidocs/index.html",target:"_blank",rel:"noopener noreferrer"},r=s(`<p><strong>例子：</strong></p><p>pom 文件导入：</p><div class="language-xml line-numbers-mode" data-ext="xml" data-title="xml"><pre class="language-xml"><code><span class="token tag"><span class="token tag"><span class="token punctuation">&lt;</span>dependency</span><span class="token punctuation">&gt;</span></span>
