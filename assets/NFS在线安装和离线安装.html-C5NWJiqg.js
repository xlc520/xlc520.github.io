import{_ as n}from"./plugin-vue_export-helper-DlAUqK2U.js";import{o as s,c as a,a as e}from"./app-Clq2mtAP.js";const i={},l=e(`<h1 id="nfs-在线安装和离线安装" tabindex="-1"><a class="header-anchor" href="#nfs-在线安装和离线安装"><span>NFS 在线安装和离线安装</span></a></h1><h2 id="_1-在线安装" tabindex="-1"><a class="header-anchor" href="#_1-在线安装"><span>1. 在线安装</span></a></h2><h4 id="第一步-在文件主服务器上安装-nfs-kernel-server" tabindex="-1"><a class="header-anchor" href="#第一步-在文件主服务器上安装-nfs-kernel-server"><span>第一步：在文件主服务器上安装 <code>nfs-kernel-server</code></span></a></h4><div class="language-bash line-numbers-mode" data-ext="sh" data-title="sh"><pre class="language-bash"><code><span class="token comment"># rpcbind nfs-kernel-server nfs-common net-tools</span>
