import{_ as s}from"./plugin-vue_export-helper-DlAUqK2U.js";import{r as a,o as r,c as u,d as e,e as i,b as d,a as l}from"./app-Clq2mtAP.js";const v={},c=l(`<h1 id="springboot-定时任务动态管理" tabindex="-1"><a class="header-anchor" href="#springboot-定时任务动态管理"><span>SpringBoot 定时任务动态管理</span></a></h1><h2 id="一、功能说明" tabindex="-1"><a class="header-anchor" href="#一、功能说明"><span><strong>一、功能说明</strong></span></a></h2><p>SpringBoot 的定时任务的加强工具，实现对 SpringBoot 原生的定时任务进行动态管理,完全兼容原生@Scheduled 注解,无需对原本的定时任务进行修改</p><h2 id="二、快速使用" tabindex="-1"><a class="header-anchor" href="#二、快速使用"><span><strong>二、快速使用</strong></span></a></h2><p>具体的功能已经封装成 SpringBoot-starter 即插即用</p><div class="language-plain line-numbers-mode" data-ext="plain" data-title="plain"><pre class="language-plain"><code>&lt;dependency&gt;
