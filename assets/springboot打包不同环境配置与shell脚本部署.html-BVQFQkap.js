import{_ as l}from"./plugin-vue_export-helper-DlAUqK2U.js";import{r as s,o as a,c as t,b as i,d as e,e as d,a as r}from"./app-BxuroukW.js";const v={},c=r(`<h1 id="springboot-打包不同环境配置与-shell-脚本部署" tabindex="-1"><a class="header-anchor" href="#springboot-打包不同环境配置与-shell-脚本部署"><span>SpringBoot 打包不同环境配置与 shell 脚本部署</span></a></h1><p>本篇和大家分享的是 springboot 打包并结合 shell 脚本命令部署，重点在分享一个 shell 程序启动工具，希望能便利工作；</p><ul><li>profiles 指定不同环境的配置</li><li>maven-assembly-plugin 打发布压缩包</li><li>分享 shenniu_publish.sh 程序启动工具</li><li>linux 上使用 shenniu_publish.sh 启动程序</li></ul><h1 id="profiles-指定不同环境的配置" tabindex="-1"><a class="header-anchor" href="#profiles-指定不同环境的配置"><span>profiles 指定不同环境的配置</span></a></h1><p>通常一套程序分为了很多个部署环境：开发，测试，uat，线上 等，我们要想对这些环境区分配置文件，可以通过两种方式：</p><ul><li>通过 application.yml 中编码指定 profile.active=uat 方式指定</li><li>通过 mvn 中 profiles 来区分不同环境对应的配置文件夹，人工可以手动在 idea 勾选生成不同环境的包(推荐)</li></ul><p>这里我们要讲的是第二种，首先在 mvn 中配置如下内容：</p><div class="language-plain line-numbers-mode" data-ext="plain" data-title="plain"><pre class="language-plain"><code> 1     &lt;profiles&gt;
 2         &lt;profile&gt;
 3             &lt;id&gt;node&lt;/id&gt;
 4             &lt;properties&gt;
 5                 &lt;!--传递给脚本的参数值--&gt;
